...
pub fn stype_to_name(stype: u32) []const u8 {
    return switch (stype) {
        vk.VK_STRUCTURE_TYPE_APPLICATION_INFO => "VkApplicationInfo",
        vk.VK_STRUCTURE_TYPE_DEVICE_QUEUE_CREATE_INFO => "VkDeviceQueueCreateInfo",
        vk.VK_STRUCTURE_TYPE_DEVICE_CREATE_INFO => "VkDeviceCreateInfo",
        vk.VK_STRUCTURE_TYPE_INSTANCE_CREATE_INFO => "VkInstanceCreateInfo",
        vk.VK_STRUCTURE_TYPE_MEMORY_ALLOCATE_INFO => "VkMemoryAllocateInfo",
        vk.VK_STRUCTURE_TYPE_MAPPED_MEMORY_RANGE => "VkMappedMemoryRange",
        vk.VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET => "VkWriteDescriptorSet",
        vk.VK_STRUCTURE_TYPE_COPY_DESCRIPTOR_SET => "VkCopyDescriptorSet",
        vk.VK_STRUCTURE_TYPE_BUFFER_USAGE_FLAGS_2_CREATE_INFO => "VkBufferUsageFlags2CreateInfo",
        vk.VK_STRUCTURE_TYPE_BUFFER_CREATE_INFO => "VkBufferCreateInfo",
        vk.VK_STRUCTURE_TYPE_BUFFER_VIEW_CREATE_INFO => "VkBufferViewCreateInfo",
        vk.VK_STRUCTURE_TYPE_MEMORY_BARRIER => "VkMemoryBarrier",
        vk.VK_STRUCTURE_TYPE_BUFFER_MEMORY_BARRIER => "VkBufferMemoryBarrier",
        vk.VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER => "VkImageMemoryBarrier",
        vk.VK_STRUCTURE_TYPE_IMAGE_CREATE_INFO => "VkImageCreateInfo",
        vk.VK_STRUCTURE_TYPE_IMAGE_VIEW_CREATE_INFO => "VkImageViewCreateInfo",
        vk.VK_STRUCTURE_TYPE_BIND_SPARSE_INFO => "VkBindSparseInfo",
        vk.VK_STRUCTURE_TYPE_SHADER_MODULE_CREATE_INFO => "VkShaderModuleCreateInfo",
        vk.VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_CREATE_INFO => "VkDescriptorSetLayoutCreateInfo",
        vk.VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_CREATE_INFO => "VkDescriptorPoolCreateInfo",
        vk.VK_STRUCTURE_TYPE_DESCRIPTOR_SET_ALLOCATE_INFO => "VkDescriptorSetAllocateInfo",
        vk.VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_CREATE_INFO => "VkPipelineShaderStageCreateInfo",
        vk.VK_STRUCTURE_TYPE_COMPUTE_PIPELINE_CREATE_INFO => "VkComputePipelineCreateInfo",
        vk.VK_STRUCTURE_TYPE_PIPELINE_CREATE_FLAGS_2_CREATE_INFO => "VkPipelineCreateFlags2CreateInfo",
        vk.VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_STATE_CREATE_INFO => "VkPipelineVertexInputStateCreateInfo",
        vk.VK_STRUCTURE_TYPE_PIPELINE_INPUT_ASSEMBLY_STATE_CREATE_INFO => "VkPipelineInputAssemblyStateCreateInfo",
        vk.VK_STRUCTURE_TYPE_PIPELINE_TESSELLATION_STATE_CREATE_INFO => "VkPipelineTessellationStateCreateInfo",
        vk.VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_STATE_CREATE_INFO => "VkPipelineViewportStateCreateInfo",
        vk.VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_STATE_CREATE_INFO => "VkPipelineRasterizationStateCreateInfo",
        vk.VK_STRUCTURE_TYPE_PIPELINE_MULTISAMPLE_STATE_CREATE_INFO => "VkPipelineMultisampleStateCreateInfo",
        vk.VK_STRUCTURE_TYPE_PIPELINE_COLOR_BLEND_STATE_CREATE_INFO => "VkPipelineColorBlendStateCreateInfo",
        vk.VK_STRUCTURE_TYPE_PIPELINE_DYNAMIC_STATE_CREATE_INFO => "VkPipelineDynamicStateCreateInfo",
        vk.VK_STRUCTURE_TYPE_PIPELINE_DEPTH_STENCIL_STATE_CREATE_INFO => "VkPipelineDepthStencilStateCreateInfo",
        vk.VK_STRUCTURE_TYPE_GRAPHICS_PIPELINE_CREATE_INFO => "VkGraphicsPipelineCreateInfo",
        vk.VK_STRUCTURE_TYPE_PIPELINE_CACHE_CREATE_INFO => "VkPipelineCacheCreateInfo",
        vk.VK_STRUCTURE_TYPE_PIPELINE_BINARY_CREATE_INFO_KHR => "VkPipelineBinaryCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_PIPELINE_BINARY_HANDLES_INFO_KHR => "VkPipelineBinaryHandlesInfoKHR",
        vk.VK_STRUCTURE_TYPE_PIPELINE_BINARY_KEY_KHR => "VkPipelineBinaryKeyKHR",
        vk.VK_STRUCTURE_TYPE_PIPELINE_BINARY_INFO_KHR => "VkPipelineBinaryInfoKHR",
        vk.VK_STRUCTURE_TYPE_RELEASE_CAPTURED_PIPELINE_DATA_INFO_KHR => "VkReleaseCapturedPipelineDataInfoKHR",
        vk.VK_STRUCTURE_TYPE_PIPELINE_BINARY_DATA_INFO_KHR => "VkPipelineBinaryDataInfoKHR",
        vk.VK_STRUCTURE_TYPE_PIPELINE_CREATE_INFO_KHR => "VkPipelineCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_PIPELINE_LAYOUT_CREATE_INFO => "VkPipelineLayoutCreateInfo",
        vk.VK_STRUCTURE_TYPE_SAMPLER_CREATE_INFO => "VkSamplerCreateInfo",
        vk.VK_STRUCTURE_TYPE_COMMAND_POOL_CREATE_INFO => "VkCommandPoolCreateInfo",
        vk.VK_STRUCTURE_TYPE_COMMAND_BUFFER_ALLOCATE_INFO => "VkCommandBufferAllocateInfo",
        vk.VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_INFO => "VkCommandBufferInheritanceInfo",
        vk.VK_STRUCTURE_TYPE_COMMAND_BUFFER_BEGIN_INFO => "VkCommandBufferBeginInfo",
        vk.VK_STRUCTURE_TYPE_RENDER_PASS_BEGIN_INFO => "VkRenderPassBeginInfo",
        vk.VK_STRUCTURE_TYPE_RENDER_PASS_CREATE_INFO => "VkRenderPassCreateInfo",
        vk.VK_STRUCTURE_TYPE_EVENT_CREATE_INFO => "VkEventCreateInfo",
        vk.VK_STRUCTURE_TYPE_FENCE_CREATE_INFO => "VkFenceCreateInfo",
        vk.VK_STRUCTURE_TYPE_SEMAPHORE_CREATE_INFO => "VkSemaphoreCreateInfo",
        vk.VK_STRUCTURE_TYPE_QUERY_POOL_CREATE_INFO => "VkQueryPoolCreateInfo",
        vk.VK_STRUCTURE_TYPE_FRAMEBUFFER_CREATE_INFO => "VkFramebufferCreateInfo",
        vk.VK_STRUCTURE_TYPE_SUBMIT_INFO => "VkSubmitInfo",
        vk.VK_STRUCTURE_TYPE_DISPLAY_MODE_CREATE_INFO_KHR => "VkDisplayModeCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_DISPLAY_SURFACE_CREATE_INFO_KHR => "VkDisplaySurfaceCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_DISPLAY_PRESENT_INFO_KHR => "VkDisplayPresentInfoKHR",
        vk.VK_STRUCTURE_TYPE_ANDROID_SURFACE_CREATE_INFO_KHR => "VkAndroidSurfaceCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_VI_SURFACE_CREATE_INFO_NN => "VkViSurfaceCreateInfoNN",
        vk.VK_STRUCTURE_TYPE_WAYLAND_SURFACE_CREATE_INFO_KHR => "VkWaylandSurfaceCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_WIN32_SURFACE_CREATE_INFO_KHR => "VkWin32SurfaceCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_XLIB_SURFACE_CREATE_INFO_KHR => "VkXlibSurfaceCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_XCB_SURFACE_CREATE_INFO_KHR => "VkXcbSurfaceCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_DIRECTFB_SURFACE_CREATE_INFO_EXT => "VkDirectFBSurfaceCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_IMAGEPIPE_SURFACE_CREATE_INFO_FUCHSIA => "VkImagePipeSurfaceCreateInfoFUCHSIA",
        vk.VK_STRUCTURE_TYPE_SCREEN_SURFACE_CREATE_INFO_QNX => "VkScreenSurfaceCreateInfoQNX",
        vk.VK_STRUCTURE_TYPE_SWAPCHAIN_CREATE_INFO_KHR => "VkSwapchainCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_PRESENT_INFO_KHR => "VkPresentInfoKHR",
        vk.VK_STRUCTURE_TYPE_DEBUG_REPORT_CALLBACK_CREATE_INFO_EXT => "VkDebugReportCallbackCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_VALIDATION_FLAGS_EXT => "VkValidationFlagsEXT",
        vk.VK_STRUCTURE_TYPE_VALIDATION_FEATURES_EXT => "VkValidationFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_LAYER_SETTINGS_CREATE_INFO_EXT => "VkLayerSettingsCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_STATE_RASTERIZATION_ORDER_AMD => "VkPipelineRasterizationStateRasterizationOrderAMD",
        vk.VK_STRUCTURE_TYPE_DEBUG_MARKER_OBJECT_NAME_INFO_EXT => "VkDebugMarkerObjectNameInfoEXT",
        vk.VK_STRUCTURE_TYPE_DEBUG_MARKER_OBJECT_TAG_INFO_EXT => "VkDebugMarkerObjectTagInfoEXT",
        vk.VK_STRUCTURE_TYPE_DEBUG_MARKER_MARKER_INFO_EXT => "VkDebugMarkerMarkerInfoEXT",
        vk.VK_STRUCTURE_TYPE_DEVICE_PRIVATE_DATA_CREATE_INFO => "VkDevicePrivateDataCreateInfo",
        vk.VK_STRUCTURE_TYPE_PRIVATE_DATA_SLOT_CREATE_INFO => "VkPrivateDataSlotCreateInfo",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRIVATE_DATA_FEATURES => "VkPhysicalDevicePrivateDataFeatures",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTI_DRAW_PROPERTIES_EXT => "VkPhysicalDeviceMultiDrawPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FEATURES_2 => "VkPhysicalDeviceFeatures2",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROPERTIES_2 => "VkPhysicalDeviceProperties2",
        vk.VK_STRUCTURE_TYPE_FORMAT_PROPERTIES_2 => "VkFormatProperties2",
        vk.VK_STRUCTURE_TYPE_IMAGE_FORMAT_PROPERTIES_2 => "VkImageFormatProperties2",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_FORMAT_INFO_2 => "VkPhysicalDeviceImageFormatInfo2",
        vk.VK_STRUCTURE_TYPE_QUEUE_FAMILY_PROPERTIES_2 => "VkQueueFamilyProperties2",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MEMORY_PROPERTIES_2 => "VkPhysicalDeviceMemoryProperties2",
        vk.VK_STRUCTURE_TYPE_SPARSE_IMAGE_FORMAT_PROPERTIES_2 => "VkSparseImageFormatProperties2",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SPARSE_IMAGE_FORMAT_INFO_2 => "VkPhysicalDeviceSparseImageFormatInfo2",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PUSH_DESCRIPTOR_PROPERTIES => "VkPhysicalDevicePushDescriptorProperties",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DRIVER_PROPERTIES => "VkPhysicalDeviceDriverProperties",
        vk.VK_STRUCTURE_TYPE_PRESENT_REGIONS_KHR => "VkPresentRegionsKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VARIABLE_POINTERS_FEATURES => "VkPhysicalDeviceVariablePointersFeatures",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_IMAGE_FORMAT_INFO => "VkPhysicalDeviceExternalImageFormatInfo",
        vk.VK_STRUCTURE_TYPE_EXTERNAL_IMAGE_FORMAT_PROPERTIES => "VkExternalImageFormatProperties",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_BUFFER_INFO => "VkPhysicalDeviceExternalBufferInfo",
        vk.VK_STRUCTURE_TYPE_EXTERNAL_BUFFER_PROPERTIES => "VkExternalBufferProperties",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ID_PROPERTIES => "VkPhysicalDeviceIDProperties",
        vk.VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_IMAGE_CREATE_INFO => "VkExternalMemoryImageCreateInfo",
        vk.VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_BUFFER_CREATE_INFO => "VkExternalMemoryBufferCreateInfo",
        vk.VK_STRUCTURE_TYPE_EXPORT_MEMORY_ALLOCATE_INFO => "VkExportMemoryAllocateInfo",
        vk.VK_STRUCTURE_TYPE_IMPORT_MEMORY_WIN32_HANDLE_INFO_KHR => "VkImportMemoryWin32HandleInfoKHR",
        vk.VK_STRUCTURE_TYPE_EXPORT_MEMORY_WIN32_HANDLE_INFO_KHR => "VkExportMemoryWin32HandleInfoKHR",
        vk.VK_STRUCTURE_TYPE_IMPORT_MEMORY_ZIRCON_HANDLE_INFO_FUCHSIA => "VkImportMemoryZirconHandleInfoFUCHSIA",
        vk.VK_STRUCTURE_TYPE_MEMORY_ZIRCON_HANDLE_PROPERTIES_FUCHSIA => "VkMemoryZirconHandlePropertiesFUCHSIA",
        vk.VK_STRUCTURE_TYPE_MEMORY_GET_ZIRCON_HANDLE_INFO_FUCHSIA => "VkMemoryGetZirconHandleInfoFUCHSIA",
        vk.VK_STRUCTURE_TYPE_MEMORY_WIN32_HANDLE_PROPERTIES_KHR => "VkMemoryWin32HandlePropertiesKHR",
        vk.VK_STRUCTURE_TYPE_MEMORY_GET_WIN32_HANDLE_INFO_KHR => "VkMemoryGetWin32HandleInfoKHR",
        vk.VK_STRUCTURE_TYPE_IMPORT_MEMORY_FD_INFO_KHR => "VkImportMemoryFdInfoKHR",
        vk.VK_STRUCTURE_TYPE_MEMORY_FD_PROPERTIES_KHR => "VkMemoryFdPropertiesKHR",
        vk.VK_STRUCTURE_TYPE_MEMORY_GET_FD_INFO_KHR => "VkMemoryGetFdInfoKHR",
        vk.VK_STRUCTURE_TYPE_WIN32_KEYED_MUTEX_ACQUIRE_RELEASE_INFO_KHR => "VkWin32KeyedMutexAcquireReleaseInfoKHR",
        vk.VK_STRUCTURE_TYPE_IMPORT_MEMORY_METAL_HANDLE_INFO_EXT => "VkImportMemoryMetalHandleInfoEXT",
        vk.VK_STRUCTURE_TYPE_MEMORY_METAL_HANDLE_PROPERTIES_EXT => "VkMemoryMetalHandlePropertiesEXT",
        vk.VK_STRUCTURE_TYPE_MEMORY_GET_METAL_HANDLE_INFO_EXT => "VkMemoryGetMetalHandleInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_SEMAPHORE_INFO => "VkPhysicalDeviceExternalSemaphoreInfo",
        vk.VK_STRUCTURE_TYPE_EXTERNAL_SEMAPHORE_PROPERTIES => "VkExternalSemaphoreProperties",
        vk.VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_CREATE_INFO => "VkExportSemaphoreCreateInfo",
        vk.VK_STRUCTURE_TYPE_IMPORT_SEMAPHORE_WIN32_HANDLE_INFO_KHR => "VkImportSemaphoreWin32HandleInfoKHR",
        vk.VK_STRUCTURE_TYPE_EXPORT_SEMAPHORE_WIN32_HANDLE_INFO_KHR => "VkExportSemaphoreWin32HandleInfoKHR",
        vk.VK_STRUCTURE_TYPE_D3D12_FENCE_SUBMIT_INFO_KHR => "VkD3D12FenceSubmitInfoKHR",
        vk.VK_STRUCTURE_TYPE_SEMAPHORE_GET_WIN32_HANDLE_INFO_KHR => "VkSemaphoreGetWin32HandleInfoKHR",
        vk.VK_STRUCTURE_TYPE_IMPORT_SEMAPHORE_FD_INFO_KHR => "VkImportSemaphoreFdInfoKHR",
        vk.VK_STRUCTURE_TYPE_SEMAPHORE_GET_FD_INFO_KHR => "VkSemaphoreGetFdInfoKHR",
        vk.VK_STRUCTURE_TYPE_IMPORT_SEMAPHORE_ZIRCON_HANDLE_INFO_FUCHSIA => "VkImportSemaphoreZirconHandleInfoFUCHSIA",
        vk.VK_STRUCTURE_TYPE_SEMAPHORE_GET_ZIRCON_HANDLE_INFO_FUCHSIA => "VkSemaphoreGetZirconHandleInfoFUCHSIA",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_FENCE_INFO => "VkPhysicalDeviceExternalFenceInfo",
        vk.VK_STRUCTURE_TYPE_EXTERNAL_FENCE_PROPERTIES => "VkExternalFenceProperties",
        vk.VK_STRUCTURE_TYPE_EXPORT_FENCE_CREATE_INFO => "VkExportFenceCreateInfo",
        vk.VK_STRUCTURE_TYPE_IMPORT_FENCE_WIN32_HANDLE_INFO_KHR => "VkImportFenceWin32HandleInfoKHR",
        vk.VK_STRUCTURE_TYPE_EXPORT_FENCE_WIN32_HANDLE_INFO_KHR => "VkExportFenceWin32HandleInfoKHR",
        vk.VK_STRUCTURE_TYPE_FENCE_GET_WIN32_HANDLE_INFO_KHR => "VkFenceGetWin32HandleInfoKHR",
        vk.VK_STRUCTURE_TYPE_IMPORT_FENCE_FD_INFO_KHR => "VkImportFenceFdInfoKHR",
        vk.VK_STRUCTURE_TYPE_FENCE_GET_FD_INFO_KHR => "VkFenceGetFdInfoKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTIVIEW_FEATURES => "VkPhysicalDeviceMultiviewFeatures",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTIVIEW_PROPERTIES => "VkPhysicalDeviceMultiviewProperties",
        vk.VK_STRUCTURE_TYPE_RENDER_PASS_MULTIVIEW_CREATE_INFO => "VkRenderPassMultiviewCreateInfo",
        vk.VK_STRUCTURE_TYPE_SURFACE_CAPABILITIES_2_EXT => "VkSurfaceCapabilities2EXT",
        vk.VK_STRUCTURE_TYPE_DISPLAY_POWER_INFO_EXT => "VkDisplayPowerInfoEXT",
        vk.VK_STRUCTURE_TYPE_DEVICE_EVENT_INFO_EXT => "VkDeviceEventInfoEXT",
        vk.VK_STRUCTURE_TYPE_DISPLAY_EVENT_INFO_EXT => "VkDisplayEventInfoEXT",
        vk.VK_STRUCTURE_TYPE_SWAPCHAIN_COUNTER_CREATE_INFO_EXT => "VkSwapchainCounterCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_GROUP_PROPERTIES => "VkPhysicalDeviceGroupProperties",
        vk.VK_STRUCTURE_TYPE_MEMORY_ALLOCATE_FLAGS_INFO => "VkMemoryAllocateFlagsInfo",
        vk.VK_STRUCTURE_TYPE_BIND_BUFFER_MEMORY_INFO => "VkBindBufferMemoryInfo",
        vk.VK_STRUCTURE_TYPE_BIND_BUFFER_MEMORY_DEVICE_GROUP_INFO => "VkBindBufferMemoryDeviceGroupInfo",
        vk.VK_STRUCTURE_TYPE_BIND_IMAGE_MEMORY_INFO => "VkBindImageMemoryInfo",
        vk.VK_STRUCTURE_TYPE_BIND_IMAGE_MEMORY_DEVICE_GROUP_INFO => "VkBindImageMemoryDeviceGroupInfo",
        vk.VK_STRUCTURE_TYPE_DEVICE_GROUP_RENDER_PASS_BEGIN_INFO => "VkDeviceGroupRenderPassBeginInfo",
        vk.VK_STRUCTURE_TYPE_DEVICE_GROUP_COMMAND_BUFFER_BEGIN_INFO => "VkDeviceGroupCommandBufferBeginInfo",
        vk.VK_STRUCTURE_TYPE_DEVICE_GROUP_SUBMIT_INFO => "VkDeviceGroupSubmitInfo",
        vk.VK_STRUCTURE_TYPE_DEVICE_GROUP_BIND_SPARSE_INFO => "VkDeviceGroupBindSparseInfo",
        vk.VK_STRUCTURE_TYPE_DEVICE_GROUP_PRESENT_CAPABILITIES_KHR => "VkDeviceGroupPresentCapabilitiesKHR",
        vk.VK_STRUCTURE_TYPE_IMAGE_SWAPCHAIN_CREATE_INFO_KHR => "VkImageSwapchainCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_BIND_IMAGE_MEMORY_SWAPCHAIN_INFO_KHR => "VkBindImageMemorySwapchainInfoKHR",
        vk.VK_STRUCTURE_TYPE_ACQUIRE_NEXT_IMAGE_INFO_KHR => "VkAcquireNextImageInfoKHR",
        vk.VK_STRUCTURE_TYPE_DEVICE_GROUP_PRESENT_INFO_KHR => "VkDeviceGroupPresentInfoKHR",
        vk.VK_STRUCTURE_TYPE_DEVICE_GROUP_DEVICE_CREATE_INFO => "VkDeviceGroupDeviceCreateInfo",
        vk.VK_STRUCTURE_TYPE_DEVICE_GROUP_SWAPCHAIN_CREATE_INFO_KHR => "VkDeviceGroupSwapchainCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_DESCRIPTOR_UPDATE_TEMPLATE_CREATE_INFO => "VkDescriptorUpdateTemplateCreateInfo",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_ID_FEATURES_KHR => "VkPhysicalDevicePresentIdFeaturesKHR",
        vk.VK_STRUCTURE_TYPE_PRESENT_ID_KHR => "VkPresentIdKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_ID_2_FEATURES_KHR => "VkPhysicalDevicePresentId2FeaturesKHR",
        vk.VK_STRUCTURE_TYPE_PRESENT_ID_2_KHR => "VkPresentId2KHR",
        vk.VK_STRUCTURE_TYPE_PRESENT_WAIT_2_INFO_KHR => "VkPresentWait2InfoKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_WAIT_FEATURES_KHR => "VkPhysicalDevicePresentWaitFeaturesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_WAIT_2_FEATURES_KHR => "VkPhysicalDevicePresentWait2FeaturesKHR",
        vk.VK_STRUCTURE_TYPE_DISPLAY_NATIVE_HDR_SURFACE_CAPABILITIES_AMD => "VkDisplayNativeHdrSurfaceCapabilitiesAMD",
        vk.VK_STRUCTURE_TYPE_SWAPCHAIN_DISPLAY_NATIVE_HDR_CREATE_INFO_AMD => "VkSwapchainDisplayNativeHdrCreateInfoAMD",
        vk.VK_STRUCTURE_TYPE_IOS_SURFACE_CREATE_INFO_MVK => "VkIOSSurfaceCreateInfoMVK",
        vk.VK_STRUCTURE_TYPE_MACOS_SURFACE_CREATE_INFO_MVK => "VkMacOSSurfaceCreateInfoMVK",
        vk.VK_STRUCTURE_TYPE_METAL_SURFACE_CREATE_INFO_EXT => "VkMetalSurfaceCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DISCARD_RECTANGLE_PROPERTIES_EXT => "VkPhysicalDeviceDiscardRectanglePropertiesEXT",
        vk.VK_STRUCTURE_TYPE_PIPELINE_DISCARD_RECTANGLE_STATE_CREATE_INFO_EXT => "VkPipelineDiscardRectangleStateCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTIVIEW_PER_VIEW_ATTRIBUTES_PROPERTIES_NVX => "VkPhysicalDeviceMultiviewPerViewAttributesPropertiesNVX",
        vk.VK_STRUCTURE_TYPE_RENDER_PASS_INPUT_ATTACHMENT_ASPECT_CREATE_INFO => "VkRenderPassInputAttachmentAspectCreateInfo",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SURFACE_INFO_2_KHR => "VkPhysicalDeviceSurfaceInfo2KHR",
        vk.VK_STRUCTURE_TYPE_SURFACE_CAPABILITIES_2_KHR => "VkSurfaceCapabilities2KHR",
        vk.VK_STRUCTURE_TYPE_SURFACE_FORMAT_2_KHR => "VkSurfaceFormat2KHR",
        vk.VK_STRUCTURE_TYPE_DISPLAY_PROPERTIES_2_KHR => "VkDisplayProperties2KHR",
        vk.VK_STRUCTURE_TYPE_DISPLAY_PLANE_PROPERTIES_2_KHR => "VkDisplayPlaneProperties2KHR",
        vk.VK_STRUCTURE_TYPE_DISPLAY_MODE_PROPERTIES_2_KHR => "VkDisplayModeProperties2KHR",
        vk.VK_STRUCTURE_TYPE_DISPLAY_PLANE_INFO_2_KHR => "VkDisplayPlaneInfo2KHR",
        vk.VK_STRUCTURE_TYPE_DISPLAY_PLANE_CAPABILITIES_2_KHR => "VkDisplayPlaneCapabilities2KHR",
        vk.VK_STRUCTURE_TYPE_SHARED_PRESENT_SURFACE_CAPABILITIES_KHR => "VkSharedPresentSurfaceCapabilitiesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_16BIT_STORAGE_FEATURES => "VkPhysicalDevice16BitStorageFeatures",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBGROUP_PROPERTIES => "VkPhysicalDeviceSubgroupProperties",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SUBGROUP_EXTENDED_TYPES_FEATURES => "VkPhysicalDeviceShaderSubgroupExtendedTypesFeatures",
        vk.VK_STRUCTURE_TYPE_BUFFER_MEMORY_REQUIREMENTS_INFO_2 => "VkBufferMemoryRequirementsInfo2",
        vk.VK_STRUCTURE_TYPE_DEVICE_BUFFER_MEMORY_REQUIREMENTS => "VkDeviceBufferMemoryRequirements",
        vk.VK_STRUCTURE_TYPE_IMAGE_MEMORY_REQUIREMENTS_INFO_2 => "VkImageMemoryRequirementsInfo2",
        vk.VK_STRUCTURE_TYPE_IMAGE_SPARSE_MEMORY_REQUIREMENTS_INFO_2 => "VkImageSparseMemoryRequirementsInfo2",
        vk.VK_STRUCTURE_TYPE_DEVICE_IMAGE_MEMORY_REQUIREMENTS => "VkDeviceImageMemoryRequirements",
        vk.VK_STRUCTURE_TYPE_MEMORY_REQUIREMENTS_2 => "VkMemoryRequirements2",
        vk.VK_STRUCTURE_TYPE_SPARSE_IMAGE_MEMORY_REQUIREMENTS_2 => "VkSparseImageMemoryRequirements2",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_POINT_CLIPPING_PROPERTIES => "VkPhysicalDevicePointClippingProperties",
        vk.VK_STRUCTURE_TYPE_MEMORY_DEDICATED_REQUIREMENTS => "VkMemoryDedicatedRequirements",
        vk.VK_STRUCTURE_TYPE_MEMORY_DEDICATED_ALLOCATE_INFO => "VkMemoryDedicatedAllocateInfo",
        vk.VK_STRUCTURE_TYPE_IMAGE_VIEW_USAGE_CREATE_INFO => "VkImageViewUsageCreateInfo",
        vk.VK_STRUCTURE_TYPE_IMAGE_VIEW_SLICED_CREATE_INFO_EXT => "VkImageViewSlicedCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_PIPELINE_TESSELLATION_DOMAIN_ORIGIN_STATE_CREATE_INFO => "VkPipelineTessellationDomainOriginStateCreateInfo",
        vk.VK_STRUCTURE_TYPE_SAMPLER_YCBCR_CONVERSION_INFO => "VkSamplerYcbcrConversionInfo",
        vk.VK_STRUCTURE_TYPE_SAMPLER_YCBCR_CONVERSION_CREATE_INFO => "VkSamplerYcbcrConversionCreateInfo",
        vk.VK_STRUCTURE_TYPE_BIND_IMAGE_PLANE_MEMORY_INFO => "VkBindImagePlaneMemoryInfo",
        vk.VK_STRUCTURE_TYPE_IMAGE_PLANE_MEMORY_REQUIREMENTS_INFO => "VkImagePlaneMemoryRequirementsInfo",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLER_YCBCR_CONVERSION_FEATURES => "VkPhysicalDeviceSamplerYcbcrConversionFeatures",
        vk.VK_STRUCTURE_TYPE_SAMPLER_YCBCR_CONVERSION_IMAGE_FORMAT_PROPERTIES => "VkSamplerYcbcrConversionImageFormatProperties",
        vk.VK_STRUCTURE_TYPE_TEXTURE_LOD_GATHER_FORMAT_PROPERTIES_AMD => "VkTextureLODGatherFormatPropertiesAMD",
        vk.VK_STRUCTURE_TYPE_CONDITIONAL_RENDERING_BEGIN_INFO_EXT => "VkConditionalRenderingBeginInfoEXT",
        vk.VK_STRUCTURE_TYPE_PROTECTED_SUBMIT_INFO => "VkProtectedSubmitInfo",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROTECTED_MEMORY_FEATURES => "VkPhysicalDeviceProtectedMemoryFeatures",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROTECTED_MEMORY_PROPERTIES => "VkPhysicalDeviceProtectedMemoryProperties",
        vk.VK_STRUCTURE_TYPE_DEVICE_QUEUE_INFO_2 => "VkDeviceQueueInfo2",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLER_FILTER_MINMAX_PROPERTIES => "VkPhysicalDeviceSamplerFilterMinmaxProperties",
        vk.VK_STRUCTURE_TYPE_SAMPLE_LOCATIONS_INFO_EXT => "VkSampleLocationsInfoEXT",
        vk.VK_STRUCTURE_TYPE_RENDER_PASS_SAMPLE_LOCATIONS_BEGIN_INFO_EXT => "VkRenderPassSampleLocationsBeginInfoEXT",
        vk.VK_STRUCTURE_TYPE_PIPELINE_SAMPLE_LOCATIONS_STATE_CREATE_INFO_EXT => "VkPipelineSampleLocationsStateCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SAMPLE_LOCATIONS_PROPERTIES_EXT => "VkPhysicalDeviceSampleLocationsPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_MULTISAMPLE_PROPERTIES_EXT => "VkMultisamplePropertiesEXT",
        vk.VK_STRUCTURE_TYPE_SAMPLER_REDUCTION_MODE_CREATE_INFO => "VkSamplerReductionModeCreateInfo",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BLEND_OPERATION_ADVANCED_FEATURES_EXT => "VkPhysicalDeviceBlendOperationAdvancedFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTI_DRAW_FEATURES_EXT => "VkPhysicalDeviceMultiDrawFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BLEND_OPERATION_ADVANCED_PROPERTIES_EXT => "VkPhysicalDeviceBlendOperationAdvancedPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_PIPELINE_COLOR_BLEND_ADVANCED_STATE_CREATE_INFO_EXT => "VkPipelineColorBlendAdvancedStateCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INLINE_UNIFORM_BLOCK_FEATURES => "VkPhysicalDeviceInlineUniformBlockFeatures",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INLINE_UNIFORM_BLOCK_PROPERTIES => "VkPhysicalDeviceInlineUniformBlockProperties",
        vk.VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_INLINE_UNIFORM_BLOCK => "VkWriteDescriptorSetInlineUniformBlock",
        vk.VK_STRUCTURE_TYPE_DESCRIPTOR_POOL_INLINE_UNIFORM_BLOCK_CREATE_INFO => "VkDescriptorPoolInlineUniformBlockCreateInfo",
        vk.VK_STRUCTURE_TYPE_IMAGE_FORMAT_LIST_CREATE_INFO => "VkImageFormatListCreateInfo",
        vk.VK_STRUCTURE_TYPE_VALIDATION_CACHE_CREATE_INFO_EXT => "VkValidationCacheCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_SHADER_MODULE_VALIDATION_CACHE_CREATE_INFO_EXT => "VkShaderModuleValidationCacheCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_3_PROPERTIES => "VkPhysicalDeviceMaintenance3Properties",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_4_FEATURES => "VkPhysicalDeviceMaintenance4Features",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_4_PROPERTIES => "VkPhysicalDeviceMaintenance4Properties",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_5_FEATURES => "VkPhysicalDeviceMaintenance5Features",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_5_PROPERTIES => "VkPhysicalDeviceMaintenance5Properties",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_6_FEATURES => "VkPhysicalDeviceMaintenance6Features",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_6_PROPERTIES => "VkPhysicalDeviceMaintenance6Properties",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_7_FEATURES_KHR => "VkPhysicalDeviceMaintenance7FeaturesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_7_PROPERTIES_KHR => "VkPhysicalDeviceMaintenance7PropertiesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LAYERED_API_PROPERTIES_LIST_KHR => "VkPhysicalDeviceLayeredApiPropertiesListKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LAYERED_API_PROPERTIES_KHR => "VkPhysicalDeviceLayeredApiPropertiesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LAYERED_API_VULKAN_PROPERTIES_KHR => "VkPhysicalDeviceLayeredApiVulkanPropertiesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_8_FEATURES_KHR => "VkPhysicalDeviceMaintenance8FeaturesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_9_FEATURES_KHR => "VkPhysicalDeviceMaintenance9FeaturesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAINTENANCE_9_PROPERTIES_KHR => "VkPhysicalDeviceMaintenance9PropertiesKHR",
        vk.VK_STRUCTURE_TYPE_QUEUE_FAMILY_OWNERSHIP_TRANSFER_PROPERTIES_KHR => "VkQueueFamilyOwnershipTransferPropertiesKHR",
        vk.VK_STRUCTURE_TYPE_RENDERING_AREA_INFO => "VkRenderingAreaInfo",
        vk.VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_SUPPORT => "VkDescriptorSetLayoutSupport",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_DRAW_PARAMETERS_FEATURES => "VkPhysicalDeviceShaderDrawParametersFeatures",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_FLOAT16_INT8_FEATURES => "VkPhysicalDeviceShaderFloat16Int8Features",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FLOAT_CONTROLS_PROPERTIES => "VkPhysicalDeviceFloatControlsProperties",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HOST_QUERY_RESET_FEATURES => "VkPhysicalDeviceHostQueryResetFeatures",
        vk.VK_STRUCTURE_TYPE_DEVICE_QUEUE_GLOBAL_PRIORITY_CREATE_INFO => "VkDeviceQueueGlobalPriorityCreateInfo",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_GLOBAL_PRIORITY_QUERY_FEATURES => "VkPhysicalDeviceGlobalPriorityQueryFeatures",
        vk.VK_STRUCTURE_TYPE_QUEUE_FAMILY_GLOBAL_PRIORITY_PROPERTIES => "VkQueueFamilyGlobalPriorityProperties",
        vk.VK_STRUCTURE_TYPE_DEBUG_UTILS_OBJECT_NAME_INFO_EXT => "VkDebugUtilsObjectNameInfoEXT",
        vk.VK_STRUCTURE_TYPE_DEBUG_UTILS_OBJECT_TAG_INFO_EXT => "VkDebugUtilsObjectTagInfoEXT",
        vk.VK_STRUCTURE_TYPE_DEBUG_UTILS_LABEL_EXT => "VkDebugUtilsLabelEXT",
        vk.VK_STRUCTURE_TYPE_DEBUG_UTILS_MESSENGER_CREATE_INFO_EXT => "VkDebugUtilsMessengerCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_DEBUG_UTILS_MESSENGER_CALLBACK_DATA_EXT => "VkDebugUtilsMessengerCallbackDataEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEVICE_MEMORY_REPORT_FEATURES_EXT => "VkPhysicalDeviceDeviceMemoryReportFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_DEVICE_DEVICE_MEMORY_REPORT_CREATE_INFO_EXT => "VkDeviceDeviceMemoryReportCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_DEVICE_MEMORY_REPORT_CALLBACK_DATA_EXT => "VkDeviceMemoryReportCallbackDataEXT",
        vk.VK_STRUCTURE_TYPE_IMPORT_MEMORY_HOST_POINTER_INFO_EXT => "VkImportMemoryHostPointerInfoEXT",
        vk.VK_STRUCTURE_TYPE_MEMORY_HOST_POINTER_PROPERTIES_EXT => "VkMemoryHostPointerPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_MEMORY_HOST_PROPERTIES_EXT => "VkPhysicalDeviceExternalMemoryHostPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CONSERVATIVE_RASTERIZATION_PROPERTIES_EXT => "VkPhysicalDeviceConservativeRasterizationPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_CALIBRATED_TIMESTAMP_INFO_KHR => "VkCalibratedTimestampInfoKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CORE_PROPERTIES_AMD => "VkPhysicalDeviceShaderCorePropertiesAMD",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CORE_PROPERTIES_2_AMD => "VkPhysicalDeviceShaderCoreProperties2AMD",
        vk.VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_CONSERVATIVE_STATE_CREATE_INFO_EXT => "VkPipelineRasterizationConservativeStateCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_FEATURES => "VkPhysicalDeviceDescriptorIndexingFeatures",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_INDEXING_PROPERTIES => "VkPhysicalDeviceDescriptorIndexingProperties",
        vk.VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_BINDING_FLAGS_CREATE_INFO => "VkDescriptorSetLayoutBindingFlagsCreateInfo",
        vk.VK_STRUCTURE_TYPE_DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_ALLOCATE_INFO => "VkDescriptorSetVariableDescriptorCountAllocateInfo",
        vk.VK_STRUCTURE_TYPE_DESCRIPTOR_SET_VARIABLE_DESCRIPTOR_COUNT_LAYOUT_SUPPORT => "VkDescriptorSetVariableDescriptorCountLayoutSupport",
        vk.VK_STRUCTURE_TYPE_ATTACHMENT_DESCRIPTION_2 => "VkAttachmentDescription2",
        vk.VK_STRUCTURE_TYPE_ATTACHMENT_REFERENCE_2 => "VkAttachmentReference2",
        vk.VK_STRUCTURE_TYPE_SUBPASS_DESCRIPTION_2 => "VkSubpassDescription2",
        vk.VK_STRUCTURE_TYPE_SUBPASS_DEPENDENCY_2 => "VkSubpassDependency2",
        vk.VK_STRUCTURE_TYPE_RENDER_PASS_CREATE_INFO_2 => "VkRenderPassCreateInfo2",
        vk.VK_STRUCTURE_TYPE_SUBPASS_BEGIN_INFO => "VkSubpassBeginInfo",
        vk.VK_STRUCTURE_TYPE_SUBPASS_END_INFO => "VkSubpassEndInfo",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_FEATURES => "VkPhysicalDeviceTimelineSemaphoreFeatures",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TIMELINE_SEMAPHORE_PROPERTIES => "VkPhysicalDeviceTimelineSemaphoreProperties",
        vk.VK_STRUCTURE_TYPE_SEMAPHORE_TYPE_CREATE_INFO => "VkSemaphoreTypeCreateInfo",
        vk.VK_STRUCTURE_TYPE_TIMELINE_SEMAPHORE_SUBMIT_INFO => "VkTimelineSemaphoreSubmitInfo",
        vk.VK_STRUCTURE_TYPE_SEMAPHORE_WAIT_INFO => "VkSemaphoreWaitInfo",
        vk.VK_STRUCTURE_TYPE_SEMAPHORE_SIGNAL_INFO => "VkSemaphoreSignalInfo",
        vk.VK_STRUCTURE_TYPE_PIPELINE_VERTEX_INPUT_DIVISOR_STATE_CREATE_INFO => "VkPipelineVertexInputDivisorStateCreateInfo",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_PROPERTIES_EXT => "VkPhysicalDeviceVertexAttributeDivisorPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_PROPERTIES => "VkPhysicalDeviceVertexAttributeDivisorProperties",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PCI_BUS_INFO_PROPERTIES_EXT => "VkPhysicalDevicePCIBusInfoPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_CONDITIONAL_RENDERING_INFO_EXT => "VkCommandBufferInheritanceConditionalRenderingInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_8BIT_STORAGE_FEATURES => "VkPhysicalDevice8BitStorageFeatures",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CONDITIONAL_RENDERING_FEATURES_EXT => "VkPhysicalDeviceConditionalRenderingFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_MEMORY_MODEL_FEATURES => "VkPhysicalDeviceVulkanMemoryModelFeatures",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_ATOMIC_INT64_FEATURES => "VkPhysicalDeviceShaderAtomicInt64Features",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_ATOMIC_FLOAT_FEATURES_EXT => "VkPhysicalDeviceShaderAtomicFloatFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_ATOMIC_FLOAT_2_FEATURES_EXT => "VkPhysicalDeviceShaderAtomicFloat2FeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_DIVISOR_FEATURES => "VkPhysicalDeviceVertexAttributeDivisorFeatures",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_STENCIL_RESOLVE_PROPERTIES => "VkPhysicalDeviceDepthStencilResolveProperties",
        vk.VK_STRUCTURE_TYPE_SUBPASS_DESCRIPTION_DEPTH_STENCIL_RESOLVE => "VkSubpassDescriptionDepthStencilResolve",
        vk.VK_STRUCTURE_TYPE_IMAGE_VIEW_ASTC_DECODE_MODE_EXT => "VkImageViewASTCDecodeModeEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ASTC_DECODE_FEATURES_EXT => "VkPhysicalDeviceASTCDecodeFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TRANSFORM_FEEDBACK_FEATURES_EXT => "VkPhysicalDeviceTransformFeedbackFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TRANSFORM_FEEDBACK_PROPERTIES_EXT => "VkPhysicalDeviceTransformFeedbackPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_STATE_STREAM_CREATE_INFO_EXT => "VkPipelineRasterizationStateStreamCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COMPUTE_SHADER_DERIVATIVES_FEATURES_KHR => "VkPhysicalDeviceComputeShaderDerivativesFeaturesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COMPUTE_SHADER_DERIVATIVES_PROPERTIES_KHR => "VkPhysicalDeviceComputeShaderDerivativesPropertiesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MESH_SHADER_FEATURES_EXT => "VkPhysicalDeviceMeshShaderFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MESH_SHADER_PROPERTIES_EXT => "VkPhysicalDeviceMeshShaderPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_RAY_TRACING_SHADER_GROUP_CREATE_INFO_KHR => "VkRayTracingShaderGroupCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_RAY_TRACING_PIPELINE_CREATE_INFO_KHR => "VkRayTracingPipelineCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_ACCELERATION_STRUCTURE_KHR => "VkWriteDescriptorSetAccelerationStructureKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ACCELERATION_STRUCTURE_FEATURES_KHR => "VkPhysicalDeviceAccelerationStructureFeaturesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_PIPELINE_FEATURES_KHR => "VkPhysicalDeviceRayTracingPipelineFeaturesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_QUERY_FEATURES_KHR => "VkPhysicalDeviceRayQueryFeaturesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ACCELERATION_STRUCTURE_PROPERTIES_KHR => "VkPhysicalDeviceAccelerationStructurePropertiesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_PIPELINE_PROPERTIES_KHR => "VkPhysicalDeviceRayTracingPipelinePropertiesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_MAINTENANCE_1_FEATURES_KHR => "VkPhysicalDeviceRayTracingMaintenance1FeaturesKHR",
        vk.VK_STRUCTURE_TYPE_DRM_FORMAT_MODIFIER_PROPERTIES_LIST_EXT => "VkDrmFormatModifierPropertiesListEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_DRM_FORMAT_MODIFIER_INFO_EXT => "VkPhysicalDeviceImageDrmFormatModifierInfoEXT",
        vk.VK_STRUCTURE_TYPE_IMAGE_DRM_FORMAT_MODIFIER_LIST_CREATE_INFO_EXT => "VkImageDrmFormatModifierListCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_IMAGE_DRM_FORMAT_MODIFIER_EXPLICIT_CREATE_INFO_EXT => "VkImageDrmFormatModifierExplicitCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_IMAGE_DRM_FORMAT_MODIFIER_PROPERTIES_EXT => "VkImageDrmFormatModifierPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_IMAGE_STENCIL_USAGE_CREATE_INFO => "VkImageStencilUsageCreateInfo",
        vk.VK_STRUCTURE_TYPE_DEVICE_MEMORY_OVERALLOCATION_CREATE_INFO_AMD => "VkDeviceMemoryOverallocationCreateInfoAMD",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_FEATURES_EXT => "VkPhysicalDeviceFragmentDensityMapFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_2_FEATURES_EXT => "VkPhysicalDeviceFragmentDensityMap2FeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_OFFSET_FEATURES_EXT => "VkPhysicalDeviceFragmentDensityMapOffsetFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_PROPERTIES_EXT => "VkPhysicalDeviceFragmentDensityMapPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_2_PROPERTIES_EXT => "VkPhysicalDeviceFragmentDensityMap2PropertiesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_OFFSET_PROPERTIES_EXT => "VkPhysicalDeviceFragmentDensityMapOffsetPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_RENDER_PASS_FRAGMENT_DENSITY_MAP_CREATE_INFO_EXT => "VkRenderPassFragmentDensityMapCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_RENDER_PASS_FRAGMENT_DENSITY_MAP_OFFSET_END_INFO_EXT => "VkRenderPassFragmentDensityMapOffsetEndInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SCALAR_BLOCK_LAYOUT_FEATURES => "VkPhysicalDeviceScalarBlockLayoutFeatures",
        vk.VK_STRUCTURE_TYPE_SURFACE_PROTECTED_CAPABILITIES_KHR => "VkSurfaceProtectedCapabilitiesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_UNIFORM_BUFFER_STANDARD_LAYOUT_FEATURES => "VkPhysicalDeviceUniformBufferStandardLayoutFeatures",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_CLIP_ENABLE_FEATURES_EXT => "VkPhysicalDeviceDepthClipEnableFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_DEPTH_CLIP_STATE_CREATE_INFO_EXT => "VkPipelineRasterizationDepthClipStateCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MEMORY_BUDGET_PROPERTIES_EXT => "VkPhysicalDeviceMemoryBudgetPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MEMORY_PRIORITY_FEATURES_EXT => "VkPhysicalDeviceMemoryPriorityFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_MEMORY_PRIORITY_ALLOCATE_INFO_EXT => "VkMemoryPriorityAllocateInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PAGEABLE_DEVICE_LOCAL_MEMORY_FEATURES_EXT => "VkPhysicalDevicePageableDeviceLocalMemoryFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BUFFER_DEVICE_ADDRESS_FEATURES => "VkPhysicalDeviceBufferDeviceAddressFeatures",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BUFFER_DEVICE_ADDRESS_FEATURES_EXT => "VkPhysicalDeviceBufferDeviceAddressFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_BUFFER_DEVICE_ADDRESS_INFO => "VkBufferDeviceAddressInfo",
        vk.VK_STRUCTURE_TYPE_BUFFER_OPAQUE_CAPTURE_ADDRESS_CREATE_INFO => "VkBufferOpaqueCaptureAddressCreateInfo",
        vk.VK_STRUCTURE_TYPE_BUFFER_DEVICE_ADDRESS_CREATE_INFO_EXT => "VkBufferDeviceAddressCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_VIEW_IMAGE_FORMAT_INFO_EXT => "VkPhysicalDeviceImageViewImageFormatInfoEXT",
        vk.VK_STRUCTURE_TYPE_FILTER_CUBIC_IMAGE_VIEW_IMAGE_FORMAT_PROPERTIES_EXT => "VkFilterCubicImageViewImageFormatPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGELESS_FRAMEBUFFER_FEATURES => "VkPhysicalDeviceImagelessFramebufferFeatures",
        vk.VK_STRUCTURE_TYPE_FRAMEBUFFER_ATTACHMENTS_CREATE_INFO => "VkFramebufferAttachmentsCreateInfo",
        vk.VK_STRUCTURE_TYPE_FRAMEBUFFER_ATTACHMENT_IMAGE_INFO => "VkFramebufferAttachmentImageInfo",
        vk.VK_STRUCTURE_TYPE_RENDER_PASS_ATTACHMENT_BEGIN_INFO => "VkRenderPassAttachmentBeginInfo",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TEXTURE_COMPRESSION_ASTC_HDR_FEATURES => "VkPhysicalDeviceTextureCompressionASTCHDRFeatures",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_YCBCR_IMAGE_ARRAYS_FEATURES_EXT => "VkPhysicalDeviceYcbcrImageArraysFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_IMAGE_VIEW_HANDLE_INFO_NVX => "VkImageViewHandleInfoNVX",
        vk.VK_STRUCTURE_TYPE_IMAGE_VIEW_ADDRESS_PROPERTIES_NVX => "VkImageViewAddressPropertiesNVX",
        vk.VK_STRUCTURE_TYPE_PIPELINE_CREATION_FEEDBACK_CREATE_INFO => "VkPipelineCreationFeedbackCreateInfo",
        vk.VK_STRUCTURE_TYPE_SURFACE_FULL_SCREEN_EXCLUSIVE_INFO_EXT => "VkSurfaceFullScreenExclusiveInfoEXT",
        vk.VK_STRUCTURE_TYPE_SURFACE_FULL_SCREEN_EXCLUSIVE_WIN32_INFO_EXT => "VkSurfaceFullScreenExclusiveWin32InfoEXT",
        vk.VK_STRUCTURE_TYPE_SURFACE_CAPABILITIES_FULL_SCREEN_EXCLUSIVE_EXT => "VkSurfaceCapabilitiesFullScreenExclusiveEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PERFORMANCE_QUERY_FEATURES_KHR => "VkPhysicalDevicePerformanceQueryFeaturesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PERFORMANCE_QUERY_PROPERTIES_KHR => "VkPhysicalDevicePerformanceQueryPropertiesKHR",
        vk.VK_STRUCTURE_TYPE_PERFORMANCE_COUNTER_KHR => "VkPerformanceCounterKHR",
        vk.VK_STRUCTURE_TYPE_PERFORMANCE_COUNTER_DESCRIPTION_KHR => "VkPerformanceCounterDescriptionKHR",
        vk.VK_STRUCTURE_TYPE_QUERY_POOL_PERFORMANCE_CREATE_INFO_KHR => "VkQueryPoolPerformanceCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_ACQUIRE_PROFILING_LOCK_INFO_KHR => "VkAcquireProfilingLockInfoKHR",
        vk.VK_STRUCTURE_TYPE_PERFORMANCE_QUERY_SUBMIT_INFO_KHR => "VkPerformanceQuerySubmitInfoKHR",
        vk.VK_STRUCTURE_TYPE_HEADLESS_SURFACE_CREATE_INFO_EXT => "VkHeadlessSurfaceCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_INTEGER_FUNCTIONS_2_FEATURES_INTEL => "VkPhysicalDeviceShaderIntegerFunctions2FeaturesINTEL",
        vk.VK_STRUCTURE_TYPE_INITIALIZE_PERFORMANCE_API_INFO_INTEL => "VkInitializePerformanceApiInfoINTEL",
        vk.VK_STRUCTURE_TYPE_QUERY_POOL_PERFORMANCE_QUERY_CREATE_INFO_INTEL => "VkQueryPoolPerformanceQueryCreateInfoINTEL",
        vk.VK_STRUCTURE_TYPE_PERFORMANCE_MARKER_INFO_INTEL => "VkPerformanceMarkerInfoINTEL",
        vk.VK_STRUCTURE_TYPE_PERFORMANCE_STREAM_MARKER_INFO_INTEL => "VkPerformanceStreamMarkerInfoINTEL",
        vk.VK_STRUCTURE_TYPE_PERFORMANCE_OVERRIDE_INFO_INTEL => "VkPerformanceOverrideInfoINTEL",
        vk.VK_STRUCTURE_TYPE_PERFORMANCE_CONFIGURATION_ACQUIRE_INFO_INTEL => "VkPerformanceConfigurationAcquireInfoINTEL",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CLOCK_FEATURES_KHR => "VkPhysicalDeviceShaderClockFeaturesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_INDEX_TYPE_UINT8_FEATURES => "VkPhysicalDeviceIndexTypeUint8Features",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADER_INTERLOCK_FEATURES_EXT => "VkPhysicalDeviceFragmentShaderInterlockFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SEPARATE_DEPTH_STENCIL_LAYOUTS_FEATURES => "VkPhysicalDeviceSeparateDepthStencilLayoutsFeatures",
        vk.VK_STRUCTURE_TYPE_ATTACHMENT_REFERENCE_STENCIL_LAYOUT => "VkAttachmentReferenceStencilLayout",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRIMITIVE_TOPOLOGY_LIST_RESTART_FEATURES_EXT => "VkPhysicalDevicePrimitiveTopologyListRestartFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_ATTACHMENT_DESCRIPTION_STENCIL_LAYOUT => "VkAttachmentDescriptionStencilLayout",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_EXECUTABLE_PROPERTIES_FEATURES_KHR => "VkPhysicalDevicePipelineExecutablePropertiesFeaturesKHR",
        vk.VK_STRUCTURE_TYPE_PIPELINE_INFO_KHR => "VkPipelineInfoKHR",
        vk.VK_STRUCTURE_TYPE_PIPELINE_EXECUTABLE_PROPERTIES_KHR => "VkPipelineExecutablePropertiesKHR",
        vk.VK_STRUCTURE_TYPE_PIPELINE_EXECUTABLE_INFO_KHR => "VkPipelineExecutableInfoKHR",
        vk.VK_STRUCTURE_TYPE_PIPELINE_EXECUTABLE_STATISTIC_KHR => "VkPipelineExecutableStatisticKHR",
        vk.VK_STRUCTURE_TYPE_PIPELINE_EXECUTABLE_INTERNAL_REPRESENTATION_KHR => "VkPipelineExecutableInternalRepresentationKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_DEMOTE_TO_HELPER_INVOCATION_FEATURES => "VkPhysicalDeviceShaderDemoteToHelperInvocationFeatures",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TEXEL_BUFFER_ALIGNMENT_FEATURES_EXT => "VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TEXEL_BUFFER_ALIGNMENT_PROPERTIES => "VkPhysicalDeviceTexelBufferAlignmentProperties",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBGROUP_SIZE_CONTROL_FEATURES => "VkPhysicalDeviceSubgroupSizeControlFeatures",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBGROUP_SIZE_CONTROL_PROPERTIES => "VkPhysicalDeviceSubgroupSizeControlProperties",
        vk.VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_REQUIRED_SUBGROUP_SIZE_CREATE_INFO => "VkPipelineShaderStageRequiredSubgroupSizeCreateInfo",
        vk.VK_STRUCTURE_TYPE_MEMORY_OPAQUE_CAPTURE_ADDRESS_ALLOCATE_INFO => "VkMemoryOpaqueCaptureAddressAllocateInfo",
        vk.VK_STRUCTURE_TYPE_DEVICE_MEMORY_OPAQUE_CAPTURE_ADDRESS_INFO => "VkDeviceMemoryOpaqueCaptureAddressInfo",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LINE_RASTERIZATION_FEATURES => "VkPhysicalDeviceLineRasterizationFeatures",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LINE_RASTERIZATION_PROPERTIES => "VkPhysicalDeviceLineRasterizationProperties",
        vk.VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_LINE_STATE_CREATE_INFO => "VkPipelineRasterizationLineStateCreateInfo",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_CREATION_CACHE_CONTROL_FEATURES => "VkPhysicalDevicePipelineCreationCacheControlFeatures",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_1_FEATURES => "VkPhysicalDeviceVulkan11Features",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_1_PROPERTIES => "VkPhysicalDeviceVulkan11Properties",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_2_FEATURES => "VkPhysicalDeviceVulkan12Features",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_2_PROPERTIES => "VkPhysicalDeviceVulkan12Properties",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_3_FEATURES => "VkPhysicalDeviceVulkan13Features",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_3_PROPERTIES => "VkPhysicalDeviceVulkan13Properties",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_4_FEATURES => "VkPhysicalDeviceVulkan14Features",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VULKAN_1_4_PROPERTIES => "VkPhysicalDeviceVulkan14Properties",
        vk.VK_STRUCTURE_TYPE_PIPELINE_COMPILER_CONTROL_CREATE_INFO_AMD => "VkPipelineCompilerControlCreateInfoAMD",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COHERENT_MEMORY_FEATURES_AMD => "VkPhysicalDeviceCoherentMemoryFeaturesAMD",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TOOL_PROPERTIES => "VkPhysicalDeviceToolProperties",
        vk.VK_STRUCTURE_TYPE_SAMPLER_CUSTOM_BORDER_COLOR_CREATE_INFO_EXT => "VkSamplerCustomBorderColorCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CUSTOM_BORDER_COLOR_PROPERTIES_EXT => "VkPhysicalDeviceCustomBorderColorPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_CUSTOM_BORDER_COLOR_FEATURES_EXT => "VkPhysicalDeviceCustomBorderColorFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_SAMPLER_BORDER_COLOR_COMPONENT_MAPPING_CREATE_INFO_EXT => "VkSamplerBorderColorComponentMappingCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_BORDER_COLOR_SWIZZLE_FEATURES_EXT => "VkPhysicalDeviceBorderColorSwizzleFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_TRIANGLES_DATA_KHR => "VkAccelerationStructureGeometryTrianglesDataKHR",
        vk.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_AABBS_DATA_KHR => "VkAccelerationStructureGeometryAabbsDataKHR",
        vk.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_INSTANCES_DATA_KHR => "VkAccelerationStructureGeometryInstancesDataKHR",
        vk.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_GEOMETRY_KHR => "VkAccelerationStructureGeometryKHR",
        vk.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_BUILD_GEOMETRY_INFO_KHR => "VkAccelerationStructureBuildGeometryInfoKHR",
        vk.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_CREATE_INFO_KHR => "VkAccelerationStructureCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_DEVICE_ADDRESS_INFO_KHR => "VkAccelerationStructureDeviceAddressInfoKHR",
        vk.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_VERSION_INFO_KHR => "VkAccelerationStructureVersionInfoKHR",
        vk.VK_STRUCTURE_TYPE_COPY_ACCELERATION_STRUCTURE_INFO_KHR => "VkCopyAccelerationStructureInfoKHR",
        vk.VK_STRUCTURE_TYPE_COPY_ACCELERATION_STRUCTURE_TO_MEMORY_INFO_KHR => "VkCopyAccelerationStructureToMemoryInfoKHR",
        vk.VK_STRUCTURE_TYPE_COPY_MEMORY_TO_ACCELERATION_STRUCTURE_INFO_KHR => "VkCopyMemoryToAccelerationStructureInfoKHR",
        vk.VK_STRUCTURE_TYPE_RAY_TRACING_PIPELINE_INTERFACE_CREATE_INFO_KHR => "VkRayTracingPipelineInterfaceCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_PIPELINE_LIBRARY_CREATE_INFO_KHR => "VkPipelineLibraryCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTENDED_DYNAMIC_STATE_FEATURES_EXT => "VkPhysicalDeviceExtendedDynamicStateFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTENDED_DYNAMIC_STATE_2_FEATURES_EXT => "VkPhysicalDeviceExtendedDynamicState2FeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTENDED_DYNAMIC_STATE_3_FEATURES_EXT => "VkPhysicalDeviceExtendedDynamicState3FeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTENDED_DYNAMIC_STATE_3_PROPERTIES_EXT => "VkPhysicalDeviceExtendedDynamicState3PropertiesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ZERO_INITIALIZE_WORKGROUP_MEMORY_FEATURES => "VkPhysicalDeviceZeroInitializeWorkgroupMemoryFeatures",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SUBGROUP_UNIFORM_CONTROL_FLOW_FEATURES_KHR => "VkPhysicalDeviceShaderSubgroupUniformControlFlowFeaturesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ROBUSTNESS_2_FEATURES_KHR => "VkPhysicalDeviceRobustness2FeaturesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ROBUSTNESS_2_PROPERTIES_KHR => "VkPhysicalDeviceRobustness2PropertiesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_ROBUSTNESS_FEATURES => "VkPhysicalDeviceImageRobustnessFeatures",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_WORKGROUP_MEMORY_EXPLICIT_LAYOUT_FEATURES_KHR => "VkPhysicalDeviceWorkgroupMemoryExplicitLayoutFeaturesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_4444_FORMATS_FEATURES_EXT => "VkPhysicalDevice4444FormatsFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_BUFFER_COPY_2 => "VkBufferCopy2",
        vk.VK_STRUCTURE_TYPE_IMAGE_COPY_2 => "VkImageCopy2",
        vk.VK_STRUCTURE_TYPE_IMAGE_BLIT_2 => "VkImageBlit2",
        vk.VK_STRUCTURE_TYPE_BUFFER_IMAGE_COPY_2 => "VkBufferImageCopy2",
        vk.VK_STRUCTURE_TYPE_IMAGE_RESOLVE_2 => "VkImageResolve2",
        vk.VK_STRUCTURE_TYPE_COPY_BUFFER_INFO_2 => "VkCopyBufferInfo2",
        vk.VK_STRUCTURE_TYPE_COPY_IMAGE_INFO_2 => "VkCopyImageInfo2",
        vk.VK_STRUCTURE_TYPE_BLIT_IMAGE_INFO_2 => "VkBlitImageInfo2",
        vk.VK_STRUCTURE_TYPE_COPY_BUFFER_TO_IMAGE_INFO_2 => "VkCopyBufferToImageInfo2",
        vk.VK_STRUCTURE_TYPE_COPY_IMAGE_TO_BUFFER_INFO_2 => "VkCopyImageToBufferInfo2",
        vk.VK_STRUCTURE_TYPE_RESOLVE_IMAGE_INFO_2 => "VkResolveImageInfo2",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_IMAGE_ATOMIC_INT64_FEATURES_EXT => "VkPhysicalDeviceShaderImageAtomicInt64FeaturesEXT",
        vk.VK_STRUCTURE_TYPE_FRAGMENT_SHADING_RATE_ATTACHMENT_INFO_KHR => "VkFragmentShadingRateAttachmentInfoKHR",
        vk.VK_STRUCTURE_TYPE_PIPELINE_FRAGMENT_SHADING_RATE_STATE_CREATE_INFO_KHR => "VkPipelineFragmentShadingRateStateCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_FEATURES_KHR => "VkPhysicalDeviceFragmentShadingRateFeaturesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_PROPERTIES_KHR => "VkPhysicalDeviceFragmentShadingRatePropertiesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADING_RATE_KHR => "VkPhysicalDeviceFragmentShadingRateKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_TERMINATE_INVOCATION_FEATURES => "VkPhysicalDeviceShaderTerminateInvocationFeatures",
        vk.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_BUILD_SIZES_INFO_KHR => "VkAccelerationStructureBuildSizesInfoKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_2D_VIEW_OF_3D_FEATURES_EXT => "VkPhysicalDeviceImage2DViewOf3DFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_SLICED_VIEW_OF_3D_FEATURES_EXT => "VkPhysicalDeviceImageSlicedViewOf3DFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ATTACHMENT_FEEDBACK_LOOP_DYNAMIC_STATE_FEATURES_EXT => "VkPhysicalDeviceAttachmentFeedbackLoopDynamicStateFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LEGACY_VERTEX_ATTRIBUTES_FEATURES_EXT => "VkPhysicalDeviceLegacyVertexAttributesFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LEGACY_VERTEX_ATTRIBUTES_PROPERTIES_EXT => "VkPhysicalDeviceLegacyVertexAttributesPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MUTABLE_DESCRIPTOR_TYPE_FEATURES_EXT => "VkPhysicalDeviceMutableDescriptorTypeFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_MUTABLE_DESCRIPTOR_TYPE_CREATE_INFO_EXT => "VkMutableDescriptorTypeCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_CLIP_CONTROL_FEATURES_EXT => "VkPhysicalDeviceDepthClipControlFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ZERO_INITIALIZE_DEVICE_MEMORY_FEATURES_EXT => "VkPhysicalDeviceZeroInitializeDeviceMemoryFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEVICE_GENERATED_COMMANDS_FEATURES_EXT => "VkPhysicalDeviceDeviceGeneratedCommandsFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEVICE_GENERATED_COMMANDS_PROPERTIES_EXT => "VkPhysicalDeviceDeviceGeneratedCommandsPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_GENERATED_COMMANDS_PIPELINE_INFO_EXT => "VkGeneratedCommandsPipelineInfoEXT",
        vk.VK_STRUCTURE_TYPE_GENERATED_COMMANDS_SHADER_INFO_EXT => "VkGeneratedCommandsShaderInfoEXT",
        vk.VK_STRUCTURE_TYPE_GENERATED_COMMANDS_MEMORY_REQUIREMENTS_INFO_EXT => "VkGeneratedCommandsMemoryRequirementsInfoEXT",
        vk.VK_STRUCTURE_TYPE_INDIRECT_EXECUTION_SET_PIPELINE_INFO_EXT => "VkIndirectExecutionSetPipelineInfoEXT",
        vk.VK_STRUCTURE_TYPE_INDIRECT_EXECUTION_SET_SHADER_LAYOUT_INFO_EXT => "VkIndirectExecutionSetShaderLayoutInfoEXT",
        vk.VK_STRUCTURE_TYPE_INDIRECT_EXECUTION_SET_SHADER_INFO_EXT => "VkIndirectExecutionSetShaderInfoEXT",
        vk.VK_STRUCTURE_TYPE_INDIRECT_EXECUTION_SET_CREATE_INFO_EXT => "VkIndirectExecutionSetCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_GENERATED_COMMANDS_INFO_EXT => "VkGeneratedCommandsInfoEXT",
        vk.VK_STRUCTURE_TYPE_WRITE_INDIRECT_EXECUTION_SET_PIPELINE_EXT => "VkWriteIndirectExecutionSetPipelineEXT",
        vk.VK_STRUCTURE_TYPE_WRITE_INDIRECT_EXECUTION_SET_SHADER_EXT => "VkWriteIndirectExecutionSetShaderEXT",
        vk.VK_STRUCTURE_TYPE_INDIRECT_COMMANDS_LAYOUT_CREATE_INFO_EXT => "VkIndirectCommandsLayoutCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_INDIRECT_COMMANDS_LAYOUT_TOKEN_EXT => "VkIndirectCommandsLayoutTokenEXT",
        vk.VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_DEPTH_CLIP_CONTROL_CREATE_INFO_EXT => "VkPipelineViewportDepthClipControlCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_CLAMP_CONTROL_FEATURES_EXT => "VkPhysicalDeviceDepthClampControlFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PIPELINE_VIEWPORT_DEPTH_CLAMP_CONTROL_CREATE_INFO_EXT => "VkPipelineViewportDepthClampControlCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_INPUT_DYNAMIC_STATE_FEATURES_EXT => "VkPhysicalDeviceVertexInputDynamicStateFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_RELAXED_EXTENDED_INSTRUCTION_FEATURES_KHR => "VkPhysicalDeviceShaderRelaxedExtendedInstructionFeaturesKHR",
        vk.VK_STRUCTURE_TYPE_VERTEX_INPUT_BINDING_DESCRIPTION_2_EXT => "VkVertexInputBindingDescription2EXT",
        vk.VK_STRUCTURE_TYPE_VERTEX_INPUT_ATTRIBUTE_DESCRIPTION_2_EXT => "VkVertexInputAttributeDescription2EXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COLOR_WRITE_ENABLE_FEATURES_EXT => "VkPhysicalDeviceColorWriteEnableFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PIPELINE_COLOR_WRITE_CREATE_INFO_EXT => "VkPipelineColorWriteCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_MEMORY_BARRIER_2 => "VkMemoryBarrier2",
        vk.VK_STRUCTURE_TYPE_IMAGE_MEMORY_BARRIER_2 => "VkImageMemoryBarrier2",
        vk.VK_STRUCTURE_TYPE_BUFFER_MEMORY_BARRIER_2 => "VkBufferMemoryBarrier2",
        vk.VK_STRUCTURE_TYPE_MEMORY_BARRIER_ACCESS_FLAGS_3_KHR => "VkMemoryBarrierAccessFlags3KHR",
        vk.VK_STRUCTURE_TYPE_DEPENDENCY_INFO => "VkDependencyInfo",
        vk.VK_STRUCTURE_TYPE_SEMAPHORE_SUBMIT_INFO => "VkSemaphoreSubmitInfo",
        vk.VK_STRUCTURE_TYPE_COMMAND_BUFFER_SUBMIT_INFO => "VkCommandBufferSubmitInfo",
        vk.VK_STRUCTURE_TYPE_SUBMIT_INFO_2 => "VkSubmitInfo2",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SYNCHRONIZATION_2_FEATURES => "VkPhysicalDeviceSynchronization2Features",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_UNIFIED_IMAGE_LAYOUTS_FEATURES_KHR => "VkPhysicalDeviceUnifiedImageLayoutsFeaturesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HOST_IMAGE_COPY_FEATURES => "VkPhysicalDeviceHostImageCopyFeatures",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_HOST_IMAGE_COPY_PROPERTIES => "VkPhysicalDeviceHostImageCopyProperties",
        vk.VK_STRUCTURE_TYPE_MEMORY_TO_IMAGE_COPY => "VkMemoryToImageCopy",
        vk.VK_STRUCTURE_TYPE_IMAGE_TO_MEMORY_COPY => "VkImageToMemoryCopy",
        vk.VK_STRUCTURE_TYPE_COPY_MEMORY_TO_IMAGE_INFO => "VkCopyMemoryToImageInfo",
        vk.VK_STRUCTURE_TYPE_COPY_IMAGE_TO_MEMORY_INFO => "VkCopyImageToMemoryInfo",
        vk.VK_STRUCTURE_TYPE_COPY_IMAGE_TO_IMAGE_INFO => "VkCopyImageToImageInfo",
        vk.VK_STRUCTURE_TYPE_HOST_IMAGE_LAYOUT_TRANSITION_INFO => "VkHostImageLayoutTransitionInfo",
        vk.VK_STRUCTURE_TYPE_SUBRESOURCE_HOST_MEMCPY_SIZE => "VkSubresourceHostMemcpySize",
        vk.VK_STRUCTURE_TYPE_HOST_IMAGE_COPY_DEVICE_PERFORMANCE_QUERY => "VkHostImageCopyDevicePerformanceQuery",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRIMITIVES_GENERATED_QUERY_FEATURES_EXT => "VkPhysicalDevicePrimitivesGeneratedQueryFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LEGACY_DITHERING_FEATURES_EXT => "VkPhysicalDeviceLegacyDitheringFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MULTISAMPLED_RENDER_TO_SINGLE_SAMPLED_FEATURES_EXT => "VkPhysicalDeviceMultisampledRenderToSingleSampledFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_SURFACE_CAPABILITIES_PRESENT_ID_2_KHR => "VkSurfaceCapabilitiesPresentId2KHR",
        vk.VK_STRUCTURE_TYPE_SURFACE_CAPABILITIES_PRESENT_WAIT_2_KHR => "VkSurfaceCapabilitiesPresentWait2KHR",
        vk.VK_STRUCTURE_TYPE_SUBPASS_RESOLVE_PERFORMANCE_QUERY_EXT => "VkSubpassResolvePerformanceQueryEXT",
        vk.VK_STRUCTURE_TYPE_MULTISAMPLED_RENDER_TO_SINGLE_SAMPLED_INFO_EXT => "VkMultisampledRenderToSingleSampledInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_PROTECTED_ACCESS_FEATURES => "VkPhysicalDevicePipelineProtectedAccessFeatures",
        vk.VK_STRUCTURE_TYPE_QUEUE_FAMILY_VIDEO_PROPERTIES_KHR => "VkQueueFamilyVideoPropertiesKHR",
        vk.VK_STRUCTURE_TYPE_QUEUE_FAMILY_QUERY_RESULT_STATUS_PROPERTIES_KHR => "VkQueueFamilyQueryResultStatusPropertiesKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_PROFILE_LIST_INFO_KHR => "VkVideoProfileListInfoKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_FORMAT_INFO_KHR => "VkPhysicalDeviceVideoFormatInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_FORMAT_PROPERTIES_KHR => "VkVideoFormatPropertiesKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_QUANTIZATION_MAP_CAPABILITIES_KHR => "VkVideoEncodeQuantizationMapCapabilitiesKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_QUANTIZATION_MAP_CAPABILITIES_KHR => "VkVideoEncodeH264QuantizationMapCapabilitiesKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_QUANTIZATION_MAP_CAPABILITIES_KHR => "VkVideoEncodeH265QuantizationMapCapabilitiesKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_QUANTIZATION_MAP_CAPABILITIES_KHR => "VkVideoEncodeAV1QuantizationMapCapabilitiesKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_FORMAT_QUANTIZATION_MAP_PROPERTIES_KHR => "VkVideoFormatQuantizationMapPropertiesKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_FORMAT_H265_QUANTIZATION_MAP_PROPERTIES_KHR => "VkVideoFormatH265QuantizationMapPropertiesKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_FORMAT_AV1_QUANTIZATION_MAP_PROPERTIES_KHR => "VkVideoFormatAV1QuantizationMapPropertiesKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_PROFILE_INFO_KHR => "VkVideoProfileInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_CAPABILITIES_KHR => "VkVideoCapabilitiesKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_SESSION_MEMORY_REQUIREMENTS_KHR => "VkVideoSessionMemoryRequirementsKHR",
        vk.VK_STRUCTURE_TYPE_BIND_VIDEO_SESSION_MEMORY_INFO_KHR => "VkBindVideoSessionMemoryInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_PICTURE_RESOURCE_INFO_KHR => "VkVideoPictureResourceInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_REFERENCE_SLOT_INFO_KHR => "VkVideoReferenceSlotInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_DECODE_CAPABILITIES_KHR => "VkVideoDecodeCapabilitiesKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_DECODE_USAGE_INFO_KHR => "VkVideoDecodeUsageInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_DECODE_INFO_KHR => "VkVideoDecodeInfoKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_MAINTENANCE_1_FEATURES_KHR => "VkPhysicalDeviceVideoMaintenance1FeaturesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_MAINTENANCE_2_FEATURES_KHR => "VkPhysicalDeviceVideoMaintenance2FeaturesKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_INLINE_QUERY_INFO_KHR => "VkVideoInlineQueryInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_DECODE_H264_PROFILE_INFO_KHR => "VkVideoDecodeH264ProfileInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_DECODE_H264_CAPABILITIES_KHR => "VkVideoDecodeH264CapabilitiesKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_DECODE_H264_SESSION_PARAMETERS_ADD_INFO_KHR => "VkVideoDecodeH264SessionParametersAddInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_DECODE_H264_SESSION_PARAMETERS_CREATE_INFO_KHR => "VkVideoDecodeH264SessionParametersCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_DECODE_H264_INLINE_SESSION_PARAMETERS_INFO_KHR => "VkVideoDecodeH264InlineSessionParametersInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_DECODE_H264_PICTURE_INFO_KHR => "VkVideoDecodeH264PictureInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_DECODE_H264_DPB_SLOT_INFO_KHR => "VkVideoDecodeH264DpbSlotInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_DECODE_H265_PROFILE_INFO_KHR => "VkVideoDecodeH265ProfileInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_DECODE_H265_CAPABILITIES_KHR => "VkVideoDecodeH265CapabilitiesKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_DECODE_H265_SESSION_PARAMETERS_ADD_INFO_KHR => "VkVideoDecodeH265SessionParametersAddInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_DECODE_H265_SESSION_PARAMETERS_CREATE_INFO_KHR => "VkVideoDecodeH265SessionParametersCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_DECODE_H265_INLINE_SESSION_PARAMETERS_INFO_KHR => "VkVideoDecodeH265InlineSessionParametersInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_DECODE_H265_PICTURE_INFO_KHR => "VkVideoDecodeH265PictureInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_DECODE_H265_DPB_SLOT_INFO_KHR => "VkVideoDecodeH265DpbSlotInfoKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_DECODE_VP9_FEATURES_KHR => "VkPhysicalDeviceVideoDecodeVP9FeaturesKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_DECODE_VP9_PROFILE_INFO_KHR => "VkVideoDecodeVP9ProfileInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_DECODE_VP9_CAPABILITIES_KHR => "VkVideoDecodeVP9CapabilitiesKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_DECODE_VP9_PICTURE_INFO_KHR => "VkVideoDecodeVP9PictureInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_DECODE_AV1_PROFILE_INFO_KHR => "VkVideoDecodeAV1ProfileInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_DECODE_AV1_CAPABILITIES_KHR => "VkVideoDecodeAV1CapabilitiesKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_DECODE_AV1_SESSION_PARAMETERS_CREATE_INFO_KHR => "VkVideoDecodeAV1SessionParametersCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_DECODE_AV1_INLINE_SESSION_PARAMETERS_INFO_KHR => "VkVideoDecodeAV1InlineSessionParametersInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_DECODE_AV1_PICTURE_INFO_KHR => "VkVideoDecodeAV1PictureInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_DECODE_AV1_DPB_SLOT_INFO_KHR => "VkVideoDecodeAV1DpbSlotInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_SESSION_CREATE_INFO_KHR => "VkVideoSessionCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_SESSION_PARAMETERS_CREATE_INFO_KHR => "VkVideoSessionParametersCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_SESSION_PARAMETERS_UPDATE_INFO_KHR => "VkVideoSessionParametersUpdateInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_SESSION_PARAMETERS_GET_INFO_KHR => "VkVideoEncodeSessionParametersGetInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_SESSION_PARAMETERS_FEEDBACK_INFO_KHR => "VkVideoEncodeSessionParametersFeedbackInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_BEGIN_CODING_INFO_KHR => "VkVideoBeginCodingInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_END_CODING_INFO_KHR => "VkVideoEndCodingInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_CODING_CONTROL_INFO_KHR => "VkVideoCodingControlInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_USAGE_INFO_KHR => "VkVideoEncodeUsageInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_INFO_KHR => "VkVideoEncodeInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_QUANTIZATION_MAP_INFO_KHR => "VkVideoEncodeQuantizationMapInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_QUANTIZATION_MAP_SESSION_PARAMETERS_CREATE_INFO_KHR => "VkVideoEncodeQuantizationMapSessionParametersCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_ENCODE_QUANTIZATION_MAP_FEATURES_KHR => "VkPhysicalDeviceVideoEncodeQuantizationMapFeaturesKHR",
        vk.VK_STRUCTURE_TYPE_QUERY_POOL_VIDEO_ENCODE_FEEDBACK_CREATE_INFO_KHR => "VkQueryPoolVideoEncodeFeedbackCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_QUALITY_LEVEL_INFO_KHR => "VkVideoEncodeQualityLevelInfoKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_ENCODE_QUALITY_LEVEL_INFO_KHR => "VkPhysicalDeviceVideoEncodeQualityLevelInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_QUALITY_LEVEL_PROPERTIES_KHR => "VkVideoEncodeQualityLevelPropertiesKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_RATE_CONTROL_INFO_KHR => "VkVideoEncodeRateControlInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_RATE_CONTROL_LAYER_INFO_KHR => "VkVideoEncodeRateControlLayerInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_CAPABILITIES_KHR => "VkVideoEncodeCapabilitiesKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_CAPABILITIES_KHR => "VkVideoEncodeH264CapabilitiesKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_QUALITY_LEVEL_PROPERTIES_KHR => "VkVideoEncodeH264QualityLevelPropertiesKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_SESSION_CREATE_INFO_KHR => "VkVideoEncodeH264SessionCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_SESSION_PARAMETERS_ADD_INFO_KHR => "VkVideoEncodeH264SessionParametersAddInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_SESSION_PARAMETERS_CREATE_INFO_KHR => "VkVideoEncodeH264SessionParametersCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_SESSION_PARAMETERS_GET_INFO_KHR => "VkVideoEncodeH264SessionParametersGetInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_SESSION_PARAMETERS_FEEDBACK_INFO_KHR => "VkVideoEncodeH264SessionParametersFeedbackInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_DPB_SLOT_INFO_KHR => "VkVideoEncodeH264DpbSlotInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_PICTURE_INFO_KHR => "VkVideoEncodeH264PictureInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_PROFILE_INFO_KHR => "VkVideoEncodeH264ProfileInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_NALU_SLICE_INFO_KHR => "VkVideoEncodeH264NaluSliceInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_RATE_CONTROL_INFO_KHR => "VkVideoEncodeH264RateControlInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_GOP_REMAINING_FRAME_INFO_KHR => "VkVideoEncodeH264GopRemainingFrameInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H264_RATE_CONTROL_LAYER_INFO_KHR => "VkVideoEncodeH264RateControlLayerInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_CAPABILITIES_KHR => "VkVideoEncodeH265CapabilitiesKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_QUALITY_LEVEL_PROPERTIES_KHR => "VkVideoEncodeH265QualityLevelPropertiesKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_SESSION_CREATE_INFO_KHR => "VkVideoEncodeH265SessionCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_SESSION_PARAMETERS_ADD_INFO_KHR => "VkVideoEncodeH265SessionParametersAddInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_SESSION_PARAMETERS_CREATE_INFO_KHR => "VkVideoEncodeH265SessionParametersCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_SESSION_PARAMETERS_GET_INFO_KHR => "VkVideoEncodeH265SessionParametersGetInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_SESSION_PARAMETERS_FEEDBACK_INFO_KHR => "VkVideoEncodeH265SessionParametersFeedbackInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_PICTURE_INFO_KHR => "VkVideoEncodeH265PictureInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_NALU_SLICE_SEGMENT_INFO_KHR => "VkVideoEncodeH265NaluSliceSegmentInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_RATE_CONTROL_INFO_KHR => "VkVideoEncodeH265RateControlInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_GOP_REMAINING_FRAME_INFO_KHR => "VkVideoEncodeH265GopRemainingFrameInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_RATE_CONTROL_LAYER_INFO_KHR => "VkVideoEncodeH265RateControlLayerInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_PROFILE_INFO_KHR => "VkVideoEncodeH265ProfileInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_H265_DPB_SLOT_INFO_KHR => "VkVideoEncodeH265DpbSlotInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_CAPABILITIES_KHR => "VkVideoEncodeAV1CapabilitiesKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_QUALITY_LEVEL_PROPERTIES_KHR => "VkVideoEncodeAV1QualityLevelPropertiesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_ENCODE_AV1_FEATURES_KHR => "VkPhysicalDeviceVideoEncodeAV1FeaturesKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_SESSION_CREATE_INFO_KHR => "VkVideoEncodeAV1SessionCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_SESSION_PARAMETERS_CREATE_INFO_KHR => "VkVideoEncodeAV1SessionParametersCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_DPB_SLOT_INFO_KHR => "VkVideoEncodeAV1DpbSlotInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_PICTURE_INFO_KHR => "VkVideoEncodeAV1PictureInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_PROFILE_INFO_KHR => "VkVideoEncodeAV1ProfileInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_RATE_CONTROL_INFO_KHR => "VkVideoEncodeAV1RateControlInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_GOP_REMAINING_FRAME_INFO_KHR => "VkVideoEncodeAV1GopRemainingFrameInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_AV1_RATE_CONTROL_LAYER_INFO_KHR => "VkVideoEncodeAV1RateControlLayerInfoKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_YCBCR_2_PLANE_444_FORMATS_FEATURES_EXT => "VkPhysicalDeviceYcbcr2Plane444FormatsFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROVOKING_VERTEX_FEATURES_EXT => "VkPhysicalDeviceProvokingVertexFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PROVOKING_VERTEX_PROPERTIES_EXT => "VkPhysicalDeviceProvokingVertexPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_PIPELINE_RASTERIZATION_PROVOKING_VERTEX_STATE_CREATE_INFO_EXT => "VkPipelineRasterizationProvokingVertexStateCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_INTRA_REFRESH_CAPABILITIES_KHR => "VkVideoEncodeIntraRefreshCapabilitiesKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_SESSION_INTRA_REFRESH_CREATE_INFO_KHR => "VkVideoEncodeSessionIntraRefreshCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_ENCODE_INTRA_REFRESH_INFO_KHR => "VkVideoEncodeIntraRefreshInfoKHR",
        vk.VK_STRUCTURE_TYPE_VIDEO_REFERENCE_INTRA_REFRESH_INFO_KHR => "VkVideoReferenceIntraRefreshInfoKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VIDEO_ENCODE_INTRA_REFRESH_FEATURES_KHR => "VkPhysicalDeviceVideoEncodeIntraRefreshFeaturesKHR",
        vk.VK_STRUCTURE_TYPE_CU_MODULE_CREATE_INFO_NVX => "VkCuModuleCreateInfoNVX",
        vk.VK_STRUCTURE_TYPE_CU_MODULE_TEXTURING_MODE_CREATE_INFO_NVX => "VkCuModuleTexturingModeCreateInfoNVX",
        vk.VK_STRUCTURE_TYPE_CU_FUNCTION_CREATE_INFO_NVX => "VkCuFunctionCreateInfoNVX",
        vk.VK_STRUCTURE_TYPE_CU_LAUNCH_INFO_NVX => "VkCuLaunchInfoNVX",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_BUFFER_FEATURES_EXT => "VkPhysicalDeviceDescriptorBufferFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_BUFFER_PROPERTIES_EXT => "VkPhysicalDeviceDescriptorBufferPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_BUFFER_DENSITY_MAP_PROPERTIES_EXT => "VkPhysicalDeviceDescriptorBufferDensityMapPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_DESCRIPTOR_ADDRESS_INFO_EXT => "VkDescriptorAddressInfoEXT",
        vk.VK_STRUCTURE_TYPE_DESCRIPTOR_BUFFER_BINDING_INFO_EXT => "VkDescriptorBufferBindingInfoEXT",
        vk.VK_STRUCTURE_TYPE_DESCRIPTOR_BUFFER_BINDING_PUSH_DESCRIPTOR_BUFFER_HANDLE_EXT => "VkDescriptorBufferBindingPushDescriptorBufferHandleEXT",
        vk.VK_STRUCTURE_TYPE_DESCRIPTOR_GET_INFO_EXT => "VkDescriptorGetInfoEXT",
        vk.VK_STRUCTURE_TYPE_BUFFER_CAPTURE_DESCRIPTOR_DATA_INFO_EXT => "VkBufferCaptureDescriptorDataInfoEXT",
        vk.VK_STRUCTURE_TYPE_IMAGE_CAPTURE_DESCRIPTOR_DATA_INFO_EXT => "VkImageCaptureDescriptorDataInfoEXT",
        vk.VK_STRUCTURE_TYPE_IMAGE_VIEW_CAPTURE_DESCRIPTOR_DATA_INFO_EXT => "VkImageViewCaptureDescriptorDataInfoEXT",
        vk.VK_STRUCTURE_TYPE_SAMPLER_CAPTURE_DESCRIPTOR_DATA_INFO_EXT => "VkSamplerCaptureDescriptorDataInfoEXT",
        vk.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_CAPTURE_DESCRIPTOR_DATA_INFO_EXT => "VkAccelerationStructureCaptureDescriptorDataInfoEXT",
        vk.VK_STRUCTURE_TYPE_OPAQUE_CAPTURE_DESCRIPTOR_DATA_CREATE_INFO_EXT => "VkOpaqueCaptureDescriptorDataCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_INTEGER_DOT_PRODUCT_FEATURES => "VkPhysicalDeviceShaderIntegerDotProductFeatures",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_INTEGER_DOT_PRODUCT_PROPERTIES => "VkPhysicalDeviceShaderIntegerDotProductProperties",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DRM_PROPERTIES_EXT => "VkPhysicalDeviceDrmPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADER_BARYCENTRIC_FEATURES_KHR => "VkPhysicalDeviceFragmentShaderBarycentricFeaturesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADER_BARYCENTRIC_PROPERTIES_KHR => "VkPhysicalDeviceFragmentShaderBarycentricPropertiesKHR",
        vk.VK_STRUCTURE_TYPE_IMPORT_MEMORY_BUFFER_COLLECTION_FUCHSIA => "VkImportMemoryBufferCollectionFUCHSIA",
        vk.VK_STRUCTURE_TYPE_BUFFER_COLLECTION_IMAGE_CREATE_INFO_FUCHSIA => "VkBufferCollectionImageCreateInfoFUCHSIA",
        vk.VK_STRUCTURE_TYPE_BUFFER_COLLECTION_BUFFER_CREATE_INFO_FUCHSIA => "VkBufferCollectionBufferCreateInfoFUCHSIA",
        vk.VK_STRUCTURE_TYPE_BUFFER_COLLECTION_CREATE_INFO_FUCHSIA => "VkBufferCollectionCreateInfoFUCHSIA",
        vk.VK_STRUCTURE_TYPE_BUFFER_COLLECTION_PROPERTIES_FUCHSIA => "VkBufferCollectionPropertiesFUCHSIA",
        vk.VK_STRUCTURE_TYPE_BUFFER_CONSTRAINTS_INFO_FUCHSIA => "VkBufferConstraintsInfoFUCHSIA",
        vk.VK_STRUCTURE_TYPE_SYSMEM_COLOR_SPACE_FUCHSIA => "VkSysmemColorSpaceFUCHSIA",
        vk.VK_STRUCTURE_TYPE_IMAGE_FORMAT_CONSTRAINTS_INFO_FUCHSIA => "VkImageFormatConstraintsInfoFUCHSIA",
        vk.VK_STRUCTURE_TYPE_IMAGE_CONSTRAINTS_INFO_FUCHSIA => "VkImageConstraintsInfoFUCHSIA",
        vk.VK_STRUCTURE_TYPE_BUFFER_COLLECTION_CONSTRAINTS_INFO_FUCHSIA => "VkBufferCollectionConstraintsInfoFUCHSIA",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RGBA10X6_FORMATS_FEATURES_EXT => "VkPhysicalDeviceRGBA10X6FormatsFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_FORMAT_PROPERTIES_3 => "VkFormatProperties3",
        vk.VK_STRUCTURE_TYPE_DRM_FORMAT_MODIFIER_PROPERTIES_LIST_2_EXT => "VkDrmFormatModifierPropertiesList2EXT",
        vk.VK_STRUCTURE_TYPE_PIPELINE_RENDERING_CREATE_INFO => "VkPipelineRenderingCreateInfo",
        vk.VK_STRUCTURE_TYPE_RENDERING_INFO => "VkRenderingInfo",
        vk.VK_STRUCTURE_TYPE_RENDERING_END_INFO_EXT => "VkRenderingEndInfoEXT",
        vk.VK_STRUCTURE_TYPE_RENDERING_ATTACHMENT_INFO => "VkRenderingAttachmentInfo",
        vk.VK_STRUCTURE_TYPE_RENDERING_FRAGMENT_SHADING_RATE_ATTACHMENT_INFO_KHR => "VkRenderingFragmentShadingRateAttachmentInfoKHR",
        vk.VK_STRUCTURE_TYPE_RENDERING_FRAGMENT_DENSITY_MAP_ATTACHMENT_INFO_EXT => "VkRenderingFragmentDensityMapAttachmentInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_FEATURES => "VkPhysicalDeviceDynamicRenderingFeatures",
        vk.VK_STRUCTURE_TYPE_COMMAND_BUFFER_INHERITANCE_RENDERING_INFO => "VkCommandBufferInheritanceRenderingInfo",
        vk.VK_STRUCTURE_TYPE_ATTACHMENT_SAMPLE_COUNT_INFO_AMD => "VkAttachmentSampleCountInfoAMD",
        vk.VK_STRUCTURE_TYPE_MULTIVIEW_PER_VIEW_ATTRIBUTES_INFO_NVX => "VkMultiviewPerViewAttributesInfoNVX",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_VIEW_MIN_LOD_FEATURES_EXT => "VkPhysicalDeviceImageViewMinLodFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_IMAGE_VIEW_MIN_LOD_CREATE_INFO_EXT => "VkImageViewMinLodCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RASTERIZATION_ORDER_ATTACHMENT_ACCESS_FEATURES_EXT => "VkPhysicalDeviceRasterizationOrderAttachmentAccessFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_GRAPHICS_PIPELINE_LIBRARY_FEATURES_EXT => "VkPhysicalDeviceGraphicsPipelineLibraryFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_BINARY_FEATURES_KHR => "VkPhysicalDevicePipelineBinaryFeaturesKHR",
        vk.VK_STRUCTURE_TYPE_DEVICE_PIPELINE_BINARY_INTERNAL_CACHE_CONTROL_KHR => "VkDevicePipelineBinaryInternalCacheControlKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_BINARY_PROPERTIES_KHR => "VkPhysicalDevicePipelineBinaryPropertiesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_GRAPHICS_PIPELINE_LIBRARY_PROPERTIES_EXT => "VkPhysicalDeviceGraphicsPipelineLibraryPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_GRAPHICS_PIPELINE_LIBRARY_CREATE_INFO_EXT => "VkGraphicsPipelineLibraryCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_SET_HOST_MAPPING_FEATURES_VALVE => "VkPhysicalDeviceDescriptorSetHostMappingFeaturesVALVE",
        vk.VK_STRUCTURE_TYPE_DESCRIPTOR_SET_BINDING_REFERENCE_VALVE => "VkDescriptorSetBindingReferenceVALVE",
        vk.VK_STRUCTURE_TYPE_DESCRIPTOR_SET_LAYOUT_HOST_MAPPING_INFO_VALVE => "VkDescriptorSetLayoutHostMappingInfoVALVE",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_NESTED_COMMAND_BUFFER_FEATURES_EXT => "VkPhysicalDeviceNestedCommandBufferFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_NESTED_COMMAND_BUFFER_PROPERTIES_EXT => "VkPhysicalDeviceNestedCommandBufferPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_MODULE_IDENTIFIER_FEATURES_EXT => "VkPhysicalDeviceShaderModuleIdentifierFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_MODULE_IDENTIFIER_PROPERTIES_EXT => "VkPhysicalDeviceShaderModuleIdentifierPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_PIPELINE_SHADER_STAGE_MODULE_IDENTIFIER_CREATE_INFO_EXT => "VkPipelineShaderStageModuleIdentifierCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_SHADER_MODULE_IDENTIFIER_EXT => "VkShaderModuleIdentifierEXT",
        vk.VK_STRUCTURE_TYPE_IMAGE_COMPRESSION_CONTROL_EXT => "VkImageCompressionControlEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_COMPRESSION_CONTROL_FEATURES_EXT => "VkPhysicalDeviceImageCompressionControlFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_IMAGE_COMPRESSION_PROPERTIES_EXT => "VkImageCompressionPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_COMPRESSION_CONTROL_SWAPCHAIN_FEATURES_EXT => "VkPhysicalDeviceImageCompressionControlSwapchainFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_IMAGE_SUBRESOURCE_2 => "VkImageSubresource2",
        vk.VK_STRUCTURE_TYPE_SUBRESOURCE_LAYOUT_2 => "VkSubresourceLayout2",
        vk.VK_STRUCTURE_TYPE_RENDER_PASS_CREATION_CONTROL_EXT => "VkRenderPassCreationControlEXT",
        vk.VK_STRUCTURE_TYPE_RENDER_PASS_CREATION_FEEDBACK_CREATE_INFO_EXT => "VkRenderPassCreationFeedbackCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_RENDER_PASS_SUBPASS_FEEDBACK_CREATE_INFO_EXT => "VkRenderPassSubpassFeedbackCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SUBPASS_MERGE_FEEDBACK_FEATURES_EXT => "VkPhysicalDeviceSubpassMergeFeedbackFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_MICROMAP_BUILD_INFO_EXT => "VkMicromapBuildInfoEXT",
        vk.VK_STRUCTURE_TYPE_MICROMAP_CREATE_INFO_EXT => "VkMicromapCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_MICROMAP_VERSION_INFO_EXT => "VkMicromapVersionInfoEXT",
        vk.VK_STRUCTURE_TYPE_COPY_MICROMAP_INFO_EXT => "VkCopyMicromapInfoEXT",
        vk.VK_STRUCTURE_TYPE_COPY_MICROMAP_TO_MEMORY_INFO_EXT => "VkCopyMicromapToMemoryInfoEXT",
        vk.VK_STRUCTURE_TYPE_COPY_MEMORY_TO_MICROMAP_INFO_EXT => "VkCopyMemoryToMicromapInfoEXT",
        vk.VK_STRUCTURE_TYPE_MICROMAP_BUILD_SIZES_INFO_EXT => "VkMicromapBuildSizesInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_OPACITY_MICROMAP_FEATURES_EXT => "VkPhysicalDeviceOpacityMicromapFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_OPACITY_MICROMAP_PROPERTIES_EXT => "VkPhysicalDeviceOpacityMicromapPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_ACCELERATION_STRUCTURE_TRIANGLES_OPACITY_MICROMAP_EXT => "VkAccelerationStructureTrianglesOpacityMicromapEXT",
        vk.VK_STRUCTURE_TYPE_PIPELINE_PROPERTIES_IDENTIFIER_EXT => "VkPipelinePropertiesIdentifierEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_PROPERTIES_FEATURES_EXT => "VkPhysicalDevicePipelinePropertiesFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_EARLY_AND_LATE_FRAGMENT_TESTS_FEATURES_AMD => "VkPhysicalDeviceShaderEarlyAndLateFragmentTestsFeaturesAMD",
        vk.VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_ACQUIRE_UNMODIFIED_EXT => "VkExternalMemoryAcquireUnmodifiedEXT",
        vk.VK_STRUCTURE_TYPE_EXPORT_METAL_OBJECT_CREATE_INFO_EXT => "VkExportMetalObjectCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_EXPORT_METAL_OBJECTS_INFO_EXT => "VkExportMetalObjectsInfoEXT",
        vk.VK_STRUCTURE_TYPE_EXPORT_METAL_DEVICE_INFO_EXT => "VkExportMetalDeviceInfoEXT",
        vk.VK_STRUCTURE_TYPE_EXPORT_METAL_COMMAND_QUEUE_INFO_EXT => "VkExportMetalCommandQueueInfoEXT",
        vk.VK_STRUCTURE_TYPE_EXPORT_METAL_BUFFER_INFO_EXT => "VkExportMetalBufferInfoEXT",
        vk.VK_STRUCTURE_TYPE_IMPORT_METAL_BUFFER_INFO_EXT => "VkImportMetalBufferInfoEXT",
        vk.VK_STRUCTURE_TYPE_EXPORT_METAL_TEXTURE_INFO_EXT => "VkExportMetalTextureInfoEXT",
        vk.VK_STRUCTURE_TYPE_IMPORT_METAL_TEXTURE_INFO_EXT => "VkImportMetalTextureInfoEXT",
        vk.VK_STRUCTURE_TYPE_EXPORT_METAL_IO_SURFACE_INFO_EXT => "VkExportMetalIOSurfaceInfoEXT",
        vk.VK_STRUCTURE_TYPE_IMPORT_METAL_IO_SURFACE_INFO_EXT => "VkImportMetalIOSurfaceInfoEXT",
        vk.VK_STRUCTURE_TYPE_EXPORT_METAL_SHARED_EVENT_INFO_EXT => "VkExportMetalSharedEventInfoEXT",
        vk.VK_STRUCTURE_TYPE_IMPORT_METAL_SHARED_EVENT_INFO_EXT => "VkImportMetalSharedEventInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_NON_SEAMLESS_CUBE_MAP_FEATURES_EXT => "VkPhysicalDeviceNonSeamlessCubeMapFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_ROBUSTNESS_FEATURES => "VkPhysicalDevicePipelineRobustnessFeatures",
        vk.VK_STRUCTURE_TYPE_PIPELINE_ROBUSTNESS_CREATE_INFO => "VkPipelineRobustnessCreateInfo",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_ROBUSTNESS_PROPERTIES => "VkPhysicalDevicePipelineRobustnessProperties",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ATTACHMENT_FEEDBACK_LOOP_LAYOUT_FEATURES_EXT => "VkPhysicalDeviceAttachmentFeedbackLoopLayoutFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_ATTACHMENT_FEEDBACK_LOOP_INFO_EXT => "VkAttachmentFeedbackLoopInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ADDRESS_BINDING_REPORT_FEATURES_EXT => "VkPhysicalDeviceAddressBindingReportFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_DEVICE_ADDRESS_BINDING_CALLBACK_DATA_EXT => "VkDeviceAddressBindingCallbackDataEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FAULT_FEATURES_EXT => "VkPhysicalDeviceFaultFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_DEVICE_FAULT_COUNTS_EXT => "VkDeviceFaultCountsEXT",
        vk.VK_STRUCTURE_TYPE_DEVICE_FAULT_INFO_EXT => "VkDeviceFaultInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_LIBRARY_GROUP_HANDLES_FEATURES_EXT => "VkPhysicalDevicePipelineLibraryGroupHandlesFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_DEPTH_BIAS_INFO_EXT => "VkDepthBiasInfoEXT",
        vk.VK_STRUCTURE_TYPE_DEPTH_BIAS_REPRESENTATION_INFO_EXT => "VkDepthBiasRepresentationInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CORE_BUILTINS_PROPERTIES_ARM => "VkPhysicalDeviceShaderCoreBuiltinsPropertiesARM",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CORE_BUILTINS_FEATURES_ARM => "VkPhysicalDeviceShaderCoreBuiltinsFeaturesARM",
        vk.VK_STRUCTURE_TYPE_FRAME_BOUNDARY_EXT => "VkFrameBoundaryEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAME_BOUNDARY_FEATURES_EXT => "VkPhysicalDeviceFrameBoundaryFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_UNUSED_ATTACHMENTS_FEATURES_EXT => "VkPhysicalDeviceDynamicRenderingUnusedAttachmentsFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_SURFACE_PRESENT_MODE_KHR => "VkSurfacePresentModeKHR",
        vk.VK_STRUCTURE_TYPE_SURFACE_PRESENT_SCALING_CAPABILITIES_KHR => "VkSurfacePresentScalingCapabilitiesKHR",
        vk.VK_STRUCTURE_TYPE_SURFACE_PRESENT_MODE_COMPATIBILITY_KHR => "VkSurfacePresentModeCompatibilityKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SWAPCHAIN_MAINTENANCE_1_FEATURES_KHR => "VkPhysicalDeviceSwapchainMaintenance1FeaturesKHR",
        vk.VK_STRUCTURE_TYPE_SWAPCHAIN_PRESENT_FENCE_INFO_KHR => "VkSwapchainPresentFenceInfoKHR",
        vk.VK_STRUCTURE_TYPE_SWAPCHAIN_PRESENT_MODES_CREATE_INFO_KHR => "VkSwapchainPresentModesCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_SWAPCHAIN_PRESENT_MODE_INFO_KHR => "VkSwapchainPresentModeInfoKHR",
        vk.VK_STRUCTURE_TYPE_SWAPCHAIN_PRESENT_SCALING_CREATE_INFO_KHR => "VkSwapchainPresentScalingCreateInfoKHR",
        vk.VK_STRUCTURE_TYPE_RELEASE_SWAPCHAIN_IMAGES_INFO_KHR => "VkReleaseSwapchainImagesInfoKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_BIAS_CONTROL_FEATURES_EXT => "VkPhysicalDeviceDepthBiasControlFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_DIRECT_DRIVER_LOADING_INFO_LUNARG => "VkDirectDriverLoadingInfoLUNARG",
        vk.VK_STRUCTURE_TYPE_DIRECT_DRIVER_LOADING_LIST_LUNARG => "VkDirectDriverLoadingListLUNARG",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RAY_TRACING_POSITION_FETCH_FEATURES_KHR => "VkPhysicalDeviceRayTracingPositionFetchFeaturesKHR",
        vk.VK_STRUCTURE_TYPE_DEVICE_IMAGE_SUBRESOURCE_INFO => "VkDeviceImageSubresourceInfo",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_CORE_PROPERTIES_ARM => "VkPhysicalDeviceShaderCorePropertiesARM",
        vk.VK_STRUCTURE_TYPE_MEMORY_MAP_INFO => "VkMemoryMapInfo",
        vk.VK_STRUCTURE_TYPE_MEMORY_UNMAP_INFO => "VkMemoryUnmapInfo",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_OBJECT_FEATURES_EXT => "VkPhysicalDeviceShaderObjectFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_OBJECT_PROPERTIES_EXT => "VkPhysicalDeviceShaderObjectPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_SHADER_CREATE_INFO_EXT => "VkShaderCreateInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_TILE_IMAGE_FEATURES_EXT => "VkPhysicalDeviceShaderTileImageFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_TILE_IMAGE_PROPERTIES_EXT => "VkPhysicalDeviceShaderTileImagePropertiesEXT",
        vk.VK_STRUCTURE_TYPE_IMPORT_SCREEN_BUFFER_INFO_QNX => "VkImportScreenBufferInfoQNX",
        vk.VK_STRUCTURE_TYPE_SCREEN_BUFFER_PROPERTIES_QNX => "VkScreenBufferPropertiesQNX",
        vk.VK_STRUCTURE_TYPE_SCREEN_BUFFER_FORMAT_PROPERTIES_QNX => "VkScreenBufferFormatPropertiesQNX",
        vk.VK_STRUCTURE_TYPE_EXTERNAL_FORMAT_QNX => "VkExternalFormatQNX",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_MEMORY_SCREEN_BUFFER_FEATURES_QNX => "VkPhysicalDeviceExternalMemoryScreenBufferFeaturesQNX",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_MATRIX_FEATURES_KHR => "VkPhysicalDeviceCooperativeMatrixFeaturesKHR",
        vk.VK_STRUCTURE_TYPE_COOPERATIVE_MATRIX_PROPERTIES_KHR => "VkCooperativeMatrixPropertiesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COOPERATIVE_MATRIX_PROPERTIES_KHR => "VkPhysicalDeviceCooperativeMatrixPropertiesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ANTI_LAG_FEATURES_AMD => "VkPhysicalDeviceAntiLagFeaturesAMD",
        vk.VK_STRUCTURE_TYPE_ANTI_LAG_DATA_AMD => "VkAntiLagDataAMD",
        vk.VK_STRUCTURE_TYPE_ANTI_LAG_PRESENTATION_INFO_AMD => "VkAntiLagPresentationInfoAMD",
        vk.VK_STRUCTURE_TYPE_BIND_MEMORY_STATUS => "VkBindMemoryStatus",
        vk.VK_STRUCTURE_TYPE_BIND_DESCRIPTOR_SETS_INFO => "VkBindDescriptorSetsInfo",
        vk.VK_STRUCTURE_TYPE_PUSH_CONSTANTS_INFO => "VkPushConstantsInfo",
        vk.VK_STRUCTURE_TYPE_PUSH_DESCRIPTOR_SET_INFO => "VkPushDescriptorSetInfo",
        vk.VK_STRUCTURE_TYPE_PUSH_DESCRIPTOR_SET_WITH_TEMPLATE_INFO => "VkPushDescriptorSetWithTemplateInfo",
        vk.VK_STRUCTURE_TYPE_SET_DESCRIPTOR_BUFFER_OFFSETS_INFO_EXT => "VkSetDescriptorBufferOffsetsInfoEXT",
        vk.VK_STRUCTURE_TYPE_BIND_DESCRIPTOR_BUFFER_EMBEDDED_SAMPLERS_INFO_EXT => "VkBindDescriptorBufferEmbeddedSamplersInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_LAYERED_DRIVER_PROPERTIES_MSFT => "VkPhysicalDeviceLayeredDriverPropertiesMSFT",
        vk.VK_STRUCTURE_TYPE_DEVICE_QUEUE_SHADER_CORE_CONTROL_CREATE_INFO_ARM => "VkDeviceQueueShaderCoreControlCreateInfoARM",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SCHEDULING_CONTROLS_FEATURES_ARM => "VkPhysicalDeviceSchedulingControlsFeaturesARM",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SCHEDULING_CONTROLS_PROPERTIES_ARM => "VkPhysicalDeviceSchedulingControlsPropertiesARM",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RELAXED_LINE_RASTERIZATION_FEATURES_IMG => "VkPhysicalDeviceRelaxedLineRasterizationFeaturesIMG",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RENDER_PASS_STRIPED_FEATURES_ARM => "VkPhysicalDeviceRenderPassStripedFeaturesARM",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RENDER_PASS_STRIPED_PROPERTIES_ARM => "VkPhysicalDeviceRenderPassStripedPropertiesARM",
        vk.VK_STRUCTURE_TYPE_RENDER_PASS_STRIPE_INFO_ARM => "VkRenderPassStripeInfoARM",
        vk.VK_STRUCTURE_TYPE_RENDER_PASS_STRIPE_BEGIN_INFO_ARM => "VkRenderPassStripeBeginInfoARM",
        vk.VK_STRUCTURE_TYPE_RENDER_PASS_STRIPE_SUBMIT_INFO_ARM => "VkRenderPassStripeSubmitInfoARM",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PIPELINE_OPACITY_MICROMAP_FEATURES_ARM => "VkPhysicalDevicePipelineOpacityMicromapFeaturesARM",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_MAXIMAL_RECONVERGENCE_FEATURES_KHR => "VkPhysicalDeviceShaderMaximalReconvergenceFeaturesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_SUBGROUP_ROTATE_FEATURES => "VkPhysicalDeviceShaderSubgroupRotateFeatures",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_EXPECT_ASSUME_FEATURES => "VkPhysicalDeviceShaderExpectAssumeFeatures",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_FLOAT_CONTROLS_2_FEATURES => "VkPhysicalDeviceShaderFloatControls2Features",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DYNAMIC_RENDERING_LOCAL_READ_FEATURES => "VkPhysicalDeviceDynamicRenderingLocalReadFeatures",
        vk.VK_STRUCTURE_TYPE_RENDERING_ATTACHMENT_LOCATION_INFO => "VkRenderingAttachmentLocationInfo",
        vk.VK_STRUCTURE_TYPE_RENDERING_INPUT_ATTACHMENT_INDEX_INFO => "VkRenderingInputAttachmentIndexInfo",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_QUAD_CONTROL_FEATURES_KHR => "VkPhysicalDeviceShaderQuadControlFeaturesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAP_MEMORY_PLACED_FEATURES_EXT => "VkPhysicalDeviceMapMemoryPlacedFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MAP_MEMORY_PLACED_PROPERTIES_EXT => "VkPhysicalDeviceMapMemoryPlacedPropertiesEXT",
        vk.VK_STRUCTURE_TYPE_MEMORY_MAP_PLACED_INFO_EXT => "VkMemoryMapPlacedInfoEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_BFLOAT16_FEATURES_KHR => "VkPhysicalDeviceShaderBfloat16FeaturesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_ALIGNMENT_CONTROL_FEATURES_MESA => "VkPhysicalDeviceImageAlignmentControlFeaturesMESA",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_IMAGE_ALIGNMENT_CONTROL_PROPERTIES_MESA => "VkPhysicalDeviceImageAlignmentControlPropertiesMESA",
        vk.VK_STRUCTURE_TYPE_IMAGE_ALIGNMENT_CONTROL_CREATE_INFO_MESA => "VkImageAlignmentControlCreateInfoMESA",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_REPLICATED_COMPOSITES_FEATURES_EXT => "VkPhysicalDeviceShaderReplicatedCompositesFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_MODE_FIFO_LATEST_READY_FEATURES_KHR => "VkPhysicalDevicePresentModeFifoLatestReadyFeaturesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_ATTRIBUTE_ROBUSTNESS_FEATURES_EXT => "VkPhysicalDeviceVertexAttributeRobustnessFeaturesEXT",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_CLAMP_ZERO_ONE_FEATURES_KHR => "VkPhysicalDeviceDepthClampZeroOneFeaturesKHR",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_LAYERED_PROPERTIES_VALVE => "VkPhysicalDeviceFragmentDensityMapLayeredPropertiesVALVE",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_LAYERED_FEATURES_VALVE => "VkPhysicalDeviceFragmentDensityMapLayeredFeaturesVALVE",
        vk.VK_STRUCTURE_TYPE_PIPELINE_FRAGMENT_DENSITY_MAP_LAYERED_CREATE_INFO_VALVE => "VkPipelineFragmentDensityMapLayeredCreateInfoVALVE",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FORMAT_PACK_FEATURES_ARM => "VkPhysicalDeviceFormatPackFeaturesARM",
        vk.VK_STRUCTURE_TYPE_TENSOR_DESCRIPTION_ARM => "VkTensorDescriptionARM",
        vk.VK_STRUCTURE_TYPE_TENSOR_CREATE_INFO_ARM => "VkTensorCreateInfoARM",
        vk.VK_STRUCTURE_TYPE_TENSOR_VIEW_CREATE_INFO_ARM => "VkTensorViewCreateInfoARM",
        vk.VK_STRUCTURE_TYPE_TENSOR_MEMORY_REQUIREMENTS_INFO_ARM => "VkTensorMemoryRequirementsInfoARM",
        vk.VK_STRUCTURE_TYPE_BIND_TENSOR_MEMORY_INFO_ARM => "VkBindTensorMemoryInfoARM",
        vk.VK_STRUCTURE_TYPE_WRITE_DESCRIPTOR_SET_TENSOR_ARM => "VkWriteDescriptorSetTensorARM",
        vk.VK_STRUCTURE_TYPE_TENSOR_FORMAT_PROPERTIES_ARM => "VkTensorFormatPropertiesARM",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TENSOR_PROPERTIES_ARM => "VkPhysicalDeviceTensorPropertiesARM",
        vk.VK_STRUCTURE_TYPE_TENSOR_MEMORY_BARRIER_ARM => "VkTensorMemoryBarrierARM",
        vk.VK_STRUCTURE_TYPE_TENSOR_DEPENDENCY_INFO_ARM => "VkTensorDependencyInfoARM",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_TENSOR_FEATURES_ARM => "VkPhysicalDeviceTensorFeaturesARM",
        vk.VK_STRUCTURE_TYPE_DEVICE_TENSOR_MEMORY_REQUIREMENTS_ARM => "VkDeviceTensorMemoryRequirementsARM",
        vk.VK_STRUCTURE_TYPE_COPY_TENSOR_INFO_ARM => "VkCopyTensorInfoARM",
        vk.VK_STRUCTURE_TYPE_TENSOR_COPY_ARM => "VkTensorCopyARM",
        vk.VK_STRUCTURE_TYPE_MEMORY_DEDICATED_ALLOCATE_INFO_TENSOR_ARM => "VkMemoryDedicatedAllocateInfoTensorARM",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_BUFFER_TENSOR_PROPERTIES_ARM => "VkPhysicalDeviceDescriptorBufferTensorPropertiesARM",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DESCRIPTOR_BUFFER_TENSOR_FEATURES_ARM => "VkPhysicalDeviceDescriptorBufferTensorFeaturesARM",
        vk.VK_STRUCTURE_TYPE_TENSOR_CAPTURE_DESCRIPTOR_DATA_INFO_ARM => "VkTensorCaptureDescriptorDataInfoARM",
        vk.VK_STRUCTURE_TYPE_TENSOR_VIEW_CAPTURE_DESCRIPTOR_DATA_INFO_ARM => "VkTensorViewCaptureDescriptorDataInfoARM",
        vk.VK_STRUCTURE_TYPE_DESCRIPTOR_GET_TENSOR_INFO_ARM => "VkDescriptorGetTensorInfoARM",
        vk.VK_STRUCTURE_TYPE_FRAME_BOUNDARY_TENSORS_ARM => "VkFrameBoundaryTensorsARM",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_EXTERNAL_TENSOR_INFO_ARM => "VkPhysicalDeviceExternalTensorInfoARM",
        vk.VK_STRUCTURE_TYPE_EXTERNAL_TENSOR_PROPERTIES_ARM => "VkExternalTensorPropertiesARM",
        vk.VK_STRUCTURE_TYPE_EXTERNAL_MEMORY_TENSOR_CREATE_INFO_ARM => "VkExternalMemoryTensorCreateInfoARM",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SHADER_FLOAT8_FEATURES_EXT => "VkPhysicalDeviceShaderFloat8FeaturesEXT",
        vk.VK_STRUCTURE_TYPE_OH_SURFACE_CREATE_INFO_OHOS => "VkOHSurfaceCreateInfoOHOS",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DATA_GRAPH_FEATURES_ARM => "VkPhysicalDeviceDataGraphFeaturesARM",
        vk.VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_CONSTANT_TENSOR_SEMI_STRUCTURED_SPARSITY_INFO_ARM => "VkDataGraphPipelineConstantTensorSemiStructuredSparsityInfoARM",
        vk.VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_CONSTANT_ARM => "VkDataGraphPipelineConstantARM",
        vk.VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_RESOURCE_INFO_ARM => "VkDataGraphPipelineResourceInfoARM",
        vk.VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_COMPILER_CONTROL_CREATE_INFO_ARM => "VkDataGraphPipelineCompilerControlCreateInfoARM",
        vk.VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_CREATE_INFO_ARM => "VkDataGraphPipelineCreateInfoARM",
        vk.VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_SHADER_MODULE_CREATE_INFO_ARM => "VkDataGraphPipelineShaderModuleCreateInfoARM",
        vk.VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_SESSION_CREATE_INFO_ARM => "VkDataGraphPipelineSessionCreateInfoARM",
        vk.VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_SESSION_BIND_POINT_REQUIREMENTS_INFO_ARM => "VkDataGraphPipelineSessionBindPointRequirementsInfoARM",
        vk.VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_SESSION_BIND_POINT_REQUIREMENT_ARM => "VkDataGraphPipelineSessionBindPointRequirementARM",
        vk.VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_SESSION_MEMORY_REQUIREMENTS_INFO_ARM => "VkDataGraphPipelineSessionMemoryRequirementsInfoARM",
        vk.VK_STRUCTURE_TYPE_BIND_DATA_GRAPH_PIPELINE_SESSION_MEMORY_INFO_ARM => "VkBindDataGraphPipelineSessionMemoryInfoARM",
        vk.VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_INFO_ARM => "VkDataGraphPipelineInfoARM",
        vk.VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_PROPERTY_QUERY_RESULT_ARM => "VkDataGraphPipelinePropertyQueryResultARM",
        vk.VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_IDENTIFIER_CREATE_INFO_ARM => "VkDataGraphPipelineIdentifierCreateInfoARM",
        vk.VK_STRUCTURE_TYPE_DATA_GRAPH_PIPELINE_DISPATCH_INFO_ARM => "VkDataGraphPipelineDispatchInfoARM",
        vk.VK_STRUCTURE_TYPE_QUEUE_FAMILY_DATA_GRAPH_PROPERTIES_ARM => "VkQueueFamilyDataGraphPropertiesARM",
        vk.VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_QUEUE_FAMILY_DATA_GRAPH_PROCESSING_ENGINE_INFO_ARM => "VkPhysicalDeviceQueueFamilyDataGraphProcessingEngineInfoARM",
        vk.VK_STRUCTURE_TYPE_QUEUE_FAMILY_DATA_GRAPH_PROCESSING_ENGINE_PROPERTIES_ARM => "VkQueueFamilyDataGraphProcessingEnginePropertiesARM",
        vk.VK_STRUCTURE_TYPE_DATA_GRAPH_PROCESSING_ENGINE_CREATE_INFO_ARM => "VkDataGraphProcessingEngineCreateInfoARM",
        else => "Unknown",
    };
}
